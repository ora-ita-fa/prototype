define({
        ...
        'range':
        {
          ...
          'datetime': 
          {
            ...
            'min':
            {
              ...
              'detail' : '날짜 및 시간 {value}은(는) {min} 또는 이후여야 합니다.',
              'hint' : '{min} 또는 이후의 날짜 및 시간을 입력하십시오.'
            },
            'max':
            {
              'summary' : '날짜 및 시간이 최대 날짜보다 이후입니다.',
              'detail' : '날짜 및 시간 {value}은(는) {max} 또는 이전이어야 합니다.',
      ...
      'oj-ojInputDate':
      {
        ...
        'weekHeader': '주',
        'datePicker': '날짜 선택기',
	'inputDetail': '달력에 액세스하려면 아래로 키 또는 위로 키를 누르십시오.',
        'inputDetailBoth': '달력에 액세스하려면 아래로 키 또는 위로 키를 누르고 시간 드롭다운에 액세스하려면 Alt + 아래로 키 또는 Alt + 위로 키를 누르십시오.'
      },

      'oj-ojInputTime':
      {
        'inputDetail': '시간 드롭다운에 액세스하려면 아래로 키 또는 위로 키를 누르십시오.'
      },
      ...
      'oj-ojTable': 
      {
        ...
        {
          'summary': '행 인덱스를 사용할 수 없어서 활성 행을 변경하지 않았습니다.',
          'detail': '사용할 수 없는 행 인덱스: {rowIdx}.'
        },
        'columnRendererColumnNotFound':
        {
          'summary': '열 렌더러에 대해 ID가 {columnId}인 열을 찾을 수 없습니다.',
          'detail': '열 ID가 일치하는 열이 열 렌더러에 존재하는지 확인하십시오.'
        },
        'columnRendererOptionRequired':
        {
          'summary': '열 렌더러에 대해 옵션 {option}이(가) 필요합니다.',
          'detail': '열 렌더러에 대해 옵션 {option}을(를) 지정하십시오.'
        },
        'dataInvalidType':
        {
          'summary': '부적합한 데이터 유형입니다.',
          'detail': '적합한 데이터 유형을 지정하십시오.'
        },
        'dataUnitialized':
        {
          'summary': '데이터가 비어 있거나 초기화되지 않았습니다.',
          'detail': '데이터를 지정하십시오.'
        },
        'preActiveRowError':
        {
          'summary': '오류로 인해 활성 행을 변경하지 않았습니다.',
          'detail': '오류 세부 정보: {error}.'
        },
        'refreshRowInvalidRowIndex':
        {
          'summary': '부적합한 행 인덱스 값입니다.',
          'detail': '행 인덱스: {rowIdx}.'
        },
        'tableDataSourceInstantiated':
        {
          'summary': 'oj.TableDataSource 생성자를 호출했습니다.',
          'detail': 'oj.TableDataSource를 인스턴스화하지 마십시오. 대신 oj.ArrayTableDataSource 또는 oj.CollectionTableDataSource와 같은 하위 클래스 중 하나를 사용하십시오.'
        }
      },
      ...
      'oj-dvtBaseComponent': {
        ...
        'labelMonthShortJanuary': '1월',
        'labelMonthShortFebruary': '2월',
        'labelMonthShortMarch': '3월',
        'labelMonthShortApril': '4월',
        'labelMonthShortMay': '5월',
        'labelMonthShortJune': '6월',
        'labelMonthShortJuly': '7월',
        'labelMonthShortAugust': '8월',
        'labelMonthShortSeptember': '9월',
        'labelMonthShortOctober': '10월',
        'labelMonthShortNovember': '11월',
        'labelMonthShortDecember': '12월',
