define({
        ...
        'range':
        {
          ...
          'datetime': 
          {
            ...
            'min':
            {
              ...
              'detail' : '日時{value}は{min}以降とする必要があります。',
              'hint' : '{min}以降の日時を入力してください。'
            },
            'max':
            {
              'summary' : '日時が最大日付より後です。',
              'detail' : '日時{value}は{max}以前とする必要があります。',
      ...
      'oj-ojInputDate':
      {
        ...
        'weekHeader': '週',
        'datePicker': '日付ピッカー',
	'inputDetail': 'カレンダにアクセスするには$[↓$]キーまたは$[↑$]キーを押してください',
        'inputDetailBoth': 'カレンダにアクセスするには$[↓$]キーまたは$[↑$]キーを、時間ドロップ・ダウンにアクセスするには$[Alt$]+$[↓$]キーまたは$[Alt$]+$[↑$]キーを押してください'
      },

      'oj-ojInputTime':
      {
        'inputDetail': '時間ドロップ・ダウンにアクセスするには$[↓$]キーまたは$[↑$]キーを押してください'
      },
      ...
      'oj-ojTable': 
      {
        ...
        {
          'summary': '行索引が使用できないため、アクティブ行は変更されませんでした。',
          'detail': '使用できない行索引: {rowIdx}。'
        },
        'columnRendererColumnNotFound':
        {
          'summary': '列レンダラに対してID {columnId}の列が見つかりません。',
          'detail': '列レンダラに対して一致する列IDを持つ列が存在することを確認してください。'
        },
        'columnRendererOptionRequired':
        {
          'summary': '列レンダラにはオプション{option}が必要です。',
          'detail': '列レンダラにはオプション{option}を指定してください。'
        },
        'dataInvalidType':
        {
          'summary': 'データ型が無効です。',
          'detail': '適切なデータ型を指定してください。'
        },
        'dataUnitialized':
        {
          'summary': 'データが空か初期化されていません。',
          'detail': 'データを指定してください。'
        },
        'preActiveRowError':
        {
          'summary': 'エラーのため、アクティブ行は変更されませんでした。',
          'detail': 'エラーの詳細: {error}。'
        },
        ...
        {
          'summary': 'oj.TableDataSourceコンストラクタが呼び出されました。',
          'detail': 'oj.TableDataSourceをインスタンス化しないでください。かわりに、oj.ArrayTableDataSourceやoj.CollectionTableDataSourceなど、サブクラスのいずれかを使用してください。'
        }
      },
      ...
      'oj-dvtBaseComponent': {
        ...
        'labelMonthShortJanuary': '1月',
        'labelMonthShortFebruary': '2月',
        'labelMonthShortMarch': '3月',
        'labelMonthShortApril': '4月',
        'labelMonthShortMay': '5月',
        'labelMonthShortJune': '6月',
        'labelMonthShortJuly': '7月',
        'labelMonthShortAugust': '8月',
        'labelMonthShortSeptember': '9月',
        'labelMonthShortOctober': '10月',
        'labelMonthShortNovember': '11月',
        'labelMonthShortDecember': '12月',
