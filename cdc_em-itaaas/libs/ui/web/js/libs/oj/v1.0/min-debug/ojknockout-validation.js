define(["ojs/ojcore", "jquery", "knockout", "jqueryui", "ojs/ojknockout"], function($oj$$24$$, $$$$24$$, $ko$$2$$) {
  ...
  $oj$$24$$.$ValueBinding$._init = function $$oj$$24$$$$ValueBinding$$_init$($property$$23$$, $initProps$$1_value$$184$$, $element$$62_optionChangeFunc$$, $component$$9$$, $options$$272_valueAccessor$$9$$) {
    $initProps$$1_value$$184$$ = {};
    $options$$272_valueAccessor$$9$$ = $options$$272_valueAccessor$$9$$.call();
    $element$$62_optionChangeFunc$$ = $oj$$24$$.$ComponentBinding$.$_toJS$($options$$272_valueAccessor$$9$$[$oj$$24$$.$ValueBinding$.$_ATTRIBUTE_OPTIONCHANGE$]);
    $property$$23$$ === $oj$$24$$.$ValueBinding$.$_ATTRIBUTE_INVALID_COMPONENT_TRACKER$ ? $element$$62_optionChangeFunc$$ || $oj$$24$$.$ValueBinding$.$_registerInvalidComponentTrackerWriteback$($options$$272_valueAccessor$$9$$, $initProps$$1_value$$184$$, $component$$9$$) : $property$$23$$ === $oj$$24$$.$ValueBinding$.$_ATTRIBUTE_OPTIONCHANGE$ && $oj$$24$$.$ValueBinding$.$_registerInvalidComponentTrackerWriteback$($options$$272_valueAccessor$$9$$, $initProps$$1_value$$184$$, $component$$9$$);
    return $initProps$$1_value$$184$$
  };
  $oj$$24$$.$ValueBinding$.$_registerInvalidComponentTrackerWriteback$ = function $$oj$$24$$$$ValueBinding$$$_registerInvalidComponentTrackerWriteback$$($options$$273$$, $initProps$$2$$, $component$$10$$) {
    var $optionChangeProp$$1$$ = $oj$$24$$.$ValueBinding$.$_ATTRIBUTE_OPTIONCHANGE$, $oldOptionChangeFunc$$, $newMessages$$, $invalidComponentTrackerObs$$ = $options$$273$$[$oj$$24$$.$ValueBinding$.$_ATTRIBUTE_INVALID_COMPONENT_TRACKER$], $items$$, $matched$$ = -1, $newData$$3$$ = {};
    $oldOptionChangeFunc$$ = $oj$$24$$.$ComponentBinding$.$_toJS$($options$$273$$[$optionChangeProp$$1$$]);
    null !== $invalidComponentTrackerObs$$ && (!$oldOptionChangeFunc$$ || $oldOptionChangeFunc$$ instanceof Function) && ($initProps$$2$$[$optionChangeProp$$1$$] = function $$initProps$$2$$$$optionChangeProp$$1$$$($event$$279$$, $data$$129$$) {
      $oldOptionChangeFunc$$ && $oldOptionChangeFunc$$.call(this, $event$$279$$, $data$$129$$);
      $data$$129$$.option === $oj$$24$$.$ValueBinding$.$_ATTRIBUTE_MESSAGES$ && $ko$$2$$.isWriteableObservable($invalidComponentTrackerObs$$) && ($items$$ = $ko$$2$$.utils.unwrapObservable($invalidComponentTrackerObs$$), $oj$$24$$.$Assert$.$assertArray$($items$$), $newMessages$$ = $data$$129$$.value, $$$$24$$.each($items$$, function($index$$148$$, $item$$11$$) {
        0 > $matched$$ && $item$$11$$.component === $component$$10$$ && ($matched$$ = $index$$148$$)
