define({
      ...
      'oj-validator': 
      {
        ...
        'range':
        {
          ...
          'datetime': 
          {
            ...
            {
              'summary': '日期时间早于最早日期。',
              'detail' : '日期时间 {value} 必须等于或晚于 {min}。',
              'hint' : '请输入等于或晚于 {min} 的日期时间。'
            },
            'max':
            {
              'summary' : '日期时间晚于最晚日期。',
              'detail' : '日期时间 {value} 必须等于或早于 {max}。',
      ...
      'oj-ojInputDate':
      {
        ...
        'weekHeader': '周',
        'datePicker': '日期选择器',
	'inputDetail': '按下箭头或上箭头来访问日历',
        'inputDetailBoth': '按下箭头或上箭头来访问日历, 按 Alt + 下箭头或 Alt + 上箭头来访问时间下拉列表'
      },

      'oj-ojInputTime':
      {
        'inputDetail': '按下箭头或上箭头来访问时间下拉列表'
      },
      ...
      'oj-ojTable': 
      {
        ...
        {
          'summary': '由于行索引不可用, 未更改活动行。',
          'detail': '不可用的行索引: {rowIdx}。'
        },
        'columnRendererColumnNotFound':
        {
          'summary': '找不到列呈现器的 ID 为 {columnId} 的列。',
          'detail': '请确保列呈现器存在具有匹配列 ID 的列。'
        },
        'columnRendererOptionRequired':
        {
          'summary': '选项 {option} 对于列呈现器是必需的。',
          'detail': '请为列呈现器指定选项 {option}。'
        },
        'dataInvalidType':
        {
          'summary': '数据类型无效。',
        ...
        {
          'summary': '已调用 oj.TableDataSource 构造函数。',
          'detail': '请勿实例化 oj.TableDataSource。请改为使用一个子类, 例如 oj.ArrayTableDataSource 或 oj.CollectionTableDataSource。'
        }
      },
