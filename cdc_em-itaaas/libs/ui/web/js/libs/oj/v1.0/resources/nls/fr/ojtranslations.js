define({
        ...
        'range':
        {
          ...
          'datetime': 
          {
            ...
            'min':
            {
              ...
              'detail' : 'La date et l\'heure {value} doivent être postérieures ou égales à {min}.',
            ...
            'max':
            {
              ...
              'detail' : 'La date et l\'heure {value} doivent être antérieures ou égales à {max}.',
	...
	'inputDetail': 'Appuyez sur la touche de défilement vers le bas ou le haut pour accéder au calendrier',
        'inputDetailBoth': 'Appuyez sur la touche de défilement vers le bas ou le haut pour accéder au calendrier et sur Alt+touche de défilement vers le bas ou le haut pour accéder à la liste déroulante d\'heure'
      },

      'oj-ojInputTime':
      {
        'inputDetail': 'Appuyez sur la touche de défilement vers le bas ou le haut pour accéder à la liste déroulante d\'heure'
      },
      ...
      'oj-ojTable': 
      {
        ...
        {
          'summary': 'Ligne active non modifiée car l\'index de ligne n\'est pas disponible.',
          'detail': 'Index de ligne non disponible : {rowIdx}.'
        },
        'columnRendererColumnNotFound':
        {
          'summary': 'Colonne portant l\'ID {columnId} introuvable pour le programme d\'affichage de colonne.',
          'detail': 'Assurez-vous qu\'une colonne portant l\'ID de colonne correspondant existe pour le programme d\'affichage de colonne.'
        },
        'columnRendererOptionRequired':
        {
          'summary': 'L\'option {option} est obligatoire pour le programme d\'affichage de colonne.',
          'detail': 'Spécifiez l\'option {option} pour le programme d\'affichage de colonne.'
        },
        'dataInvalidType':
        {
          'summary': 'Type de données non valide.',
          'detail': 'Spécifiez le type de données approprié.'
        },
        'dataUnitialized':
        {
          'summary': 'Les données sont vides ou non initialisées.',
          'detail': 'Spécifiez des données.'
        },
        'preActiveRowError':
        {
          'summary': 'Ligne active non modifiée en raison d\'une erreur.',
          'detail': 'Détails de l\'erreur : {error}.'
        },
        'refreshRowInvalidRowIndex':
        {
          'summary': 'Valeur d\'index de ligne non valide.',
          'detail': 'Index de ligne : {rowIdx}.'
        },
        'tableDataSourceInstantiated':
        {
          'summary': 'Constructeur oj.TableDataSource appelé.',
          'detail': 'N\'instanciez pas oj.TableDataSource. A la place, utilisez l\'une des sous-classes, telles que oj.ArrayTableDataSource ou oj.CollectionTableDataSource.'
        }
      },
