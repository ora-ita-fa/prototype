define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtGauge"], function($oj$$14$$, $$$$14$$) {
  $oj$$14$$.$__registerWidget$("oj.dvtBaseGauge", $$$$14$$.oj.dvtBaseComponent, {option:function($key$$75$$, $value$$168$$) {
    var $previousValue$$3$$, $newValue$$6_valueOptionSet$$1$$ = !1;
    "string" === typeof $key$$75$$ && void 0 !== $value$$168$$ ? "value" === $key$$75$$ && ($newValue$$6_valueOptionSet$$1$$ = !0, $previousValue$$3$$ = this.options.value) : "object" === typeof $key$$75$$ && $key$$75$$ && void 0 !== $key$$75$$.value && ($newValue$$6_valueOptionSet$$1$$ = !0, $previousValue$$3$$ = this.options.value);
    var $ret$$30$$ = this._superApply(arguments);
    ...
    for($key$$76$$ in $superMap$$) {
      $ret$$31$$[$key$$76$$] = $superMap$$[$key$$76$$]
    }
    for($key$$76$$ in $selfMap$$) {
      $ret$$31$$[$key$$76$$] = $selfMap$$[$key$$76$$]
    }
    return $ret$$31$$
