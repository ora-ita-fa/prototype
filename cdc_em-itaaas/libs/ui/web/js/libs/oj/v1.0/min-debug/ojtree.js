define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$21$$, $$$$21$$) {
  (function() {
    ...
    function $_KeyFilterHandler$$($e$$70$$) {
      var $s$$10$$ = "";
      $e$$70$$.ctrlKey ? $s$$10$$ += "ctrl+" : $e$$70$$.shiftKey && ($s$$10$$ += "shift+");
      var $key$$84$$ = $e$$70$$.which;
      switch($key$$84$$) {
        case 32:
          $s$$10$$ += "space";
          break;
      ...
      if(0 !== $s$$10$$.length) {
        ...
        $$$$21$$.each($_aKeyHandlerStack$$, function($i$$224$$, $obj$$53$$) {
          if($obj$$53$$.$_this$.$_data$.ui.$focused$ && $obj$$53$$.$_handler$[$s$$10$$]) {
            return $e$$70$$.preventDefault(), $retHandler$$ = $obj$$53$$.$_handler$[$s$$10$$].call($obj$$53$$.$_this$, $e$$70$$), !1
          }
        });
        return $retHandler$$
      }
    ...
    function $_removeKeyFilter$$($selector$$17$$) {
      $$$$21$$.each($_aKeyHandlerStack$$, function($i$$225$$) {
        if($_aKeyHandlerStack$$[$i$$225$$].$_selector$ === $selector$$17$$) {
          return $$$$21$$($selector$$17$$).off("keydown"), $_aKeyHandlerStack$$[$i$$225$$] = null, $_aKeyHandlerStack$$.splice($i$$225$$, 1), !1
        }
      })
    }
    ...
    destroy:null, expand:null, expandAll:null, hover:null, loaded:null, move:null, paste:null, refresh:null, rename:null, select:null}, collapse:function($node$$22$$, $skipAnim$$) {
      $node$$22$$ = this.$_getNode$($node$$22$$);
      var $s$$11$$ = $skipAnim$$ || this.options.animDuration, $t$$1$$ = this;
      if(!$node$$22$$.length || -1 === $node$$22$$ || !$node$$22$$.hasClass("oj-tree-open") || this.$_data$.$core$.locked || $node$$22$$.hasClass("oj-disabled")) {
        return!1
      }
      var $rslt$$ = this.$_emitEvent$({obj:$node$$22$$, func:"collapse"}, "before");
      if("boolean" != typeof $rslt$$ || $rslt$$) {
        $s$$11$$ && $node$$22$$.children("ul").attr("style", "display:block !important"), $node$$22$$.removeClass("oj-tree-open").addClass("oj-tree-closed").attr("aria-expanded", "false"), $s$$11$$ ? $node$$22$$.children("ul").stop(!0, !0).slideUp($s$$11$$, function() {
          this.style.display = "";
          $t$$1$$.after_close($node$$22$$)
        }) : $t$$1$$.after_close($node$$22$$), this.$_emitEvent$({obj:$node$$22$$}, "collapse")
      }
    }, collapseAll:function($node$$23$$, $anim$$) {
      var $origTarg$$ = $node$$23$$ ? $node$$23$$ : -1, $_this$$2$$ = this;
      if(!this.$_data$.$core$.locked && (($node$$23$$ = $node$$23$$ ? this.$_getNode$($node$$23$$) : this.$_$container$) && -1 !== $origTarg$$ && ($origTarg$$ = $node$$23$$), $node$$23$$ && -1 !== $origTarg$$ || ($node$$23$$ = this.$_$container_ul$), !$node$$23$$.hasClass("oj-disabled"))) {
        var $subject$$;
        -1 !== $origTarg$$ && this.isExpanded($node$$23$$) && ($subject$$ = $node$$23$$[0]);
        var $objs$$ = $node$$23$$.find("li.oj-tree-open");
    ...
    }, expand:function($node$$24$$, $skipAnim$$1$$) {
      this.$_expand$($node$$24$$, !1, $skipAnim$$1$$)
      ...
      if($nodes$$ && "array" === $$$$21$$.type($nodes$$)) {
        ...
        $exlen$$ = $nodes$$.length;
        $$$$21$$.each($nodes$$, function($i$$226$$, $val$$38$$) {
          $_this$$3$$.$_expand$($val$$38$$, !1, $skipAnim$$2$$)
        });
        return null
      }
      ...
      return $$$$21$$($exlr$$)
    }, expandAll:function($node$$25$$, $anim$$1$$) {
      this.$_expandAll$($node$$25$$, $anim$$1$$)
    }, toggleExpand:function($node$$26$$) {
      $node$$26$$ = this.$_getNode$($node$$26$$);
      if(-1 !== $node$$26$$ && !$node$$26$$.hasClass("oj-disabled") && !this.$_data$.$core$.locked) {
        if($node$$26$$.hasClass("oj-tree-closed")) {
          return this.expand($node$$26$$)
        }
        if($node$$26$$.hasClass("oj-tree-open")) {
          return this.collapse($node$$26$$)
        }
      }
    }, deselect:function($node$$27$$) {
      $node$$27$$ = this.$_getNode$($node$$27$$);
      if(!$node$$27$$.length) {
        return!1
      }
      $node$$27$$.hasClass("oj-disabled") || this.$_data$.$core$.locked || !this.isSelected($node$$27$$) || ($node$$27$$.children("a").removeClass("oj-tree-clicked"), $node$$27$$.removeAttr("aria-selected"), this.$_data$.ui.selected = this.$_data$.ui.selected.not($node$$27$$), this.$_data$.ui.$last_selected$.get(0) === $node$$27$$.get(0) && (this.$_data$.ui.$last_selected$ = this.$_data$.ui.selected.eq(0)), this.$_emitEvent$({obj:$node$$27$$}, "deselect"))
    }, deselectAll:function($context$$44$$) {
      this.$_data$.$core$.locked || this.$_deselectAll$($context$$44$$, !1)
    }, select:function($node$$28$$) {
      this.$_select$($node$$28$$)
      ...
      if(void 0 !== $nodes$$1$$.length) {
        var $_this$$4$$ = this;
        $$$$21$$.each($nodes$$1$$, function($i$$227$$, $val$$39$$) {
          $val$$39$$ && $_this$$4$$.$_select$($val$$39$$, !0)
        })
      }
      return null
    }, toggleSelect:function($node$$29$$) {
      $node$$29$$ = this.$_getNode$($node$$29$$);
      if(!$node$$29$$.length) {
        return!1
      }
      $node$$29$$.hasClass("oj-disabled") || this.$_data$.$core$.locked || (this.isSelected($node$$29$$) ? this.deselect($node$$29$$) : this.$_select$($node$$29$$, !0))
    }, isCollapsed:function($node$$30$$) {
      return($node$$30$$ = this.$_getNode$($node$$30$$)) && -1 !== $node$$30$$ && $node$$30$$.hasClass("oj-tree-closed")
    }, isExpanded:function($node$$31$$) {
      return($node$$31$$ = this.$_getNode$($node$$31$$)) && -1 !== $node$$31$$ && $node$$31$$.hasClass("oj-tree-open")
    }, isLeaf:function($node$$32$$) {
      return this.$_isLeaf$($node$$32$$)
    }, isSelected:function($node$$33$$) {
      return 0 <= this.$_data$.ui.selected.index(this.$_getNode$($node$$33$$))
    }, create:function($refnode$$, $position$$9$$, $data$$112$$) {
      return this.$_create_node$($refnode$$, $position$$9$$, $data$$112$$)
    }, remove:function($node$$34$$) {
      $node$$34$$ = this.$_getNode$($node$$34$$);
      if(!$node$$34$$.length || $node$$34$$.hasClass("oj-disabled") || this.$_data$.$core$.locked) {
        return!1
      }
      var $p$$7_rslt$$1$$ = this.$_emitEvent$({obj:$node$$34$$, func:"remove"}, "before");
      if("boolean" == typeof $p$$7_rslt$$1$$ && !$p$$7_rslt$$1$$) {
        return!1
      }
      this.$__rollback$();
      var $p$$7_rslt$$1$$ = this.$_getParent$($node$$34$$), $prev$$3$$ = $$$$21$$([]), $t$$2$$ = this, $sib$$ = this.$_getPrev$($node$$34$$);
      $node$$34$$.each(function() {
        $prev$$3$$ = $prev$$3$$.add($t$$2$$.$_getPrev$(this))
      });
      $node$$34$$ = $node$$34$$.detach();
      ...
      this.$_emitEvent$({obj:$node$$34$$, prev:$sib$$, parent:$p$$7_rslt$$1$$}, "remove");
      return $node$$34$$
    }, getText:function($node$$35$$) {
      $node$$35$$ = this.$_getNode$($node$$35$$);
      if(!$node$$35$$.length) {
        return!1
      }
      var $ht$$ = this.$_data$.$core$.$htmlTitles$;
      $node$$35$$ = $node$$35$$.children("a:eq(0)");
      if($ht$$) {
        return $node$$35$$ = $node$$35$$.clone(), $node$$35$$.children("INS").remove(), $node$$35$$.html()
      }
      $node$$35$$ = $node$$35$$.find("span:eq(0)");
      return $node$$35$$[0].textContent
    }, rename:function($node$$36$$, $text$$12$$) {
      this.$_rename_node$($node$$36$$, $text$$12$$)
    }, hover:function($node$$37$$) {
      $node$$37$$ = this.$_getNode$($node$$37$$);
      if(!$node$$37$$.length) {
        return!1
      }
      if(!$node$$37$$.hasClass("oj-disabled") && !this.$_data$.$core$.locked) {
        var $rslt$$2$$ = this.$_emitEvent$({obj:$node$$37$$, func:"hover"}, "before");
        if("boolean" != typeof $rslt$$2$$ || $rslt$$2$$) {
          $node$$37$$.hasClass("oj-tree-hovered") || this.dehover(), this.$_data$.ui.$hovered$ = $node$$37$$.children("a").addClass("oj-tree-hovered").parent(), this.$_$container_ul$.attr("aria-activedescendant", this.$_data$.ui.$hovered$.attr("id")), this.$_fix_scroll$($node$$37$$), this.$_emitEvent$({obj:$node$$37$$}, "hover")
        }
      }
    }, dehover:function() {
    ...
    }, getPath:function($node$$38$$, $idMode$$) {
      var $p$$9$$ = [], $_this$$5$$ = this;
      $node$$38$$ = this.$_getNode$($node$$38$$);
      if(-1 === $node$$38$$ || !$node$$38$$ || !$node$$38$$.length) {
        return!1
      }
      $node$$38$$.parentsUntil(".oj-tree", "li").each(function() {
        $p$$9$$.push($idMode$$ ? this.id : $_this$$5$$.getText(this))
      });
      $p$$9$$.reverse();
      $p$$9$$.push($idMode$$ ? $node$$38$$.attr("id") : this.getText($node$$38$$));
      return $p$$9$$
    }, getRoot:function() {
      return this.$_$container$.children("ul:eq(0)")
    }, refresh:function($node$$39$$) {
      this._super();
      this.$_data$.$core$.locked || this.$_refresh$($node$$39$$)
    }, move:function($node$$40$$, $refnode$$1$$, $position$$10$$, $iscopy$$) {
      this.$_move_node$($node$$40$$, $refnode$$1$$, $position$$10$$, $iscopy$$)
    }, getType:function($node$$41$$) {
      return this.$_getType$($node$$41$$)
    }, setType:function($node$$42$$, $str$$17$$) {
      return this.$_setType$($node$$42$$, $str$$17$$)
        ...
        if("selectionMode" === $key$$85$$) {
          ...
          if("icons" === $key$$85$$) {
            ...
            if("contextMenu" === $key$$85$$) {
              ...
              if("disabled" === $key$$85$$) {
                $ret$$33$$ = this.$_handleDisabledChanged$($newval$$)
              }else {
                if("data" === $key$$85$$) {
                  this._super($key$$85$$, $newval$$);
                  this.$_initDSOpts$();
    ...
    }, $_isLeaf$:function($node$$43$$) {
      return($node$$43$$ = this.$_getNode$($node$$43$$)) && -1 !== $node$$43$$ && $node$$43$$.hasClass("oj-tree-leaf")
    }, $_reference$:function($node$$44$$) {
      $node$$44$$.parents("div").eq(0);
      return this
      ...
      var $obj$$61$$ = this.$_data$.$core$.$prepared_move$, $ret$$34$$ = !0, $r$$2$$;
      ...
      return $ret$$34$$
    }, $_rename_node$:function($node$$45$$, $text$$13$$) {
      var $t$$3$$;
      $node$$45$$ = this.$_getNode$($node$$45$$);
      this.$__rollback$();
      $t$$3$$ = this.getText($node$$45$$);
      if($node$$45$$ && $node$$45$$.length) {
        var $rslt$$3$$ = this.$_emitEvent$({obj:$node$$45$$, func:"rename", title:$text$$13$$, prevTitle:$t$$3$$}, "before");
        if("boolean" == typeof $rslt$$3$$ && !$rslt$$3$$) {
          return
        }
      }
      $node$$45$$ && ($node$$45$$.length && this.$_set_text$.apply(this, Array.prototype.slice.call(arguments))) && this.$_emitEvent$({obj:$node$$45$$, title:$text$$13$$, prevTitle:$t$$3$$}, "rename")
    ...
    }, $_getType$:function($node$$46$$) {
      return($node$$46$$ = this.$_getNode$($node$$46$$)) && $node$$46$$.length ? $node$$46$$.attr(this.options.types.attr) || "default" : !1
    }, $_setType$:function($str$$18$$, $node$$47$$) {
      var $s$$12$$ = this.options.types, $ret$$35$$ = !1;
      $node$$47$$ = this.$_getNode$($node$$47$$);
      ($ret$$35$$ = $s$$12$$ ? $node$$47$$.length && $str$$18$$ ? $node$$47$$.attr(this.options.types.attr, $str$$18$$) : !1 : !1) && this.$_emitEvent$({obj:$node$$47$$, type:$str$$18$$}, "settype");
      return $ret$$35$$
    }, $_check$:function($rule$$3$$, $obj$$63$$, $opts$$19$$) {
      $obj$$63$$ = this.$_getNode$($obj$$63$$);
      var $v$$1$$ = !1, $ty$$ = this.$_getType$($obj$$63$$), $d$$4$$ = 0, $_this$$7$$ = this, $s$$13$$ = this.$_getOptions$().types, $data$$113$$ = !1;
      if(-1 === $obj$$63$$) {
        if($s$$13$$[$rule$$3$$]) {
          $v$$1$$ = $s$$13$$[$rule$$3$$]
        }else {
        ...
        ($data$$113$$ = this.$_data$.types.$defaults$.useData ? $obj$$63$$.data("oj-tree") : !1) && $data$$113$$.types && "undefined" !== typeof $data$$113$$.types[$rule$$3$$] ? $v$$1$$ = $data$$113$$.types[$rule$$3$$] : $s$$13$$.types[$ty$$] && "undefined" !== typeof $s$$13$$.types[$ty$$][$rule$$3$$] ? $v$$1$$ = $s$$13$$.types[$ty$$][$rule$$3$$] : $s$$13$$.types["default"] && "undefined" !== typeof $s$$13$$.types["default"][$rule$$3$$] && ($v$$1$$ = $s$$13$$.types["default"][$rule$$3$$])
      }
      $$$$21$$.isFunction($v$$1$$) && ($v$$1$$ = $v$$1$$.call(this, $obj$$63$$));
      var $md$$ = this.$_data$.types.$defaults$.maxDepth;
      "maxDepth" === $rule$$3$$ && (-1 !== $obj$$63$$ && !1 !== $opts$$19$$ && -2 !== this.$_data$.types.$defaults$.maxDepth && 0 !== $v$$1$$) && $obj$$63$$.children("a:eq(0)").parentsUntil(".oj-tree", "li").each(function($i$$228$$) {
        if(-1 !== $md$$ && 0 >= $md$$ - ($i$$228$$ + 1)) {
          return $v$$1$$ = 0, !1
        }
        $d$$4$$ = 0 === $i$$228$$ ? $v$$1$$ : $_this$$7$$.$_check$($rule$$3$$, this, !1);
        if(-1 !== $d$$4$$ && 0 >= $d$$4$$ - ($i$$228$$ + 1)) {
          return $v$$1$$ = 0, !1
        }
        0 <= $d$$4$$ && ($d$$4$$ - ($i$$228$$ + 1) < $v$$1$$ || 0 > $v$$1$$) && ($v$$1$$ = $d$$4$$ - ($i$$228$$ + 1));
        0 <= $md$$ && ($md$$ - ($i$$228$$ + 1) < $v$$1$$ || 0 > $v$$1$$) && ($v$$1$$ = $md$$ - ($i$$228$$ + 1))
      });
      return $v$$1$$
      ...
      var $_this$$8$$ = this;
      $$$$21$$.each($js$$.data, function($i$$229$$, $m$$22$$) {
        $tmp$$3$$ = $$$$21$$("\x3ca /\x3e");
        $$$$21$$.isFunction($m$$22$$) && ($m$$22$$ = $m$$22$$.call(this, $js$$));
        if("string" == typeof $m$$22$$) {
          $tmp$$3$$.attr("href", "#")[$_this$$8$$.$_data$.$core$.$htmlTitles$ ? "html" : "text"]($m$$22$$)
        }else {
          $m$$22$$.attr || ($m$$22$$.attr = {}), $m$$22$$.attr.href || ($m$$22$$.attr.href = "#"), $tmp$$3$$.attr($m$$22$$.attr)[$_this$$8$$.$_data$.$core$.$htmlTitles$ ? "html" : "text"]($m$$22$$.title), $m$$22$$.language && $tmp$$3$$.addClass($m$$22$$.language)
        }
    ...
    }, $_select$:function($node$$48$$, $check$$, $e$$72$$) {
      if(0 == this.$_data$.$core$.$selectMode$) {
        return!1
      }
      $node$$48$$ = this.$_getNode$($node$$48$$);
      if(-1 == $node$$48$$ || !$node$$48$$ || !$node$$48$$.length) {
        return!1
      }
      if(!$node$$48$$.hasClass("oj-disabled") && !this.$_data$.$core$.locked) {
        var $rslt$$5_s$$16$$ = this.$_emitEvent$({obj:$node$$48$$, func:"select"}, "before");
        if("boolean" != typeof $rslt$$5_s$$16$$ || $rslt$$5_s$$16$$) {
          var $rslt$$5_s$$16$$ = this.options, $is_multiple_selMultMod$$ = this.$_data$.ui.$defaults$.selectMultipleModifier, $is_range_selRangeMod$$ = this.$_data$.ui.$defaults$.selectRangeModifier, $disSelChildren$$ = this.$_data$.ui.$defaults$.disableSelectingChildren, $is_multiple_selMultMod$$ = "on" == $is_multiple_selMultMod$$ || !1 !== $is_multiple_selMultMod$$ && $e$$72$$ && $e$$72$$[$is_multiple_selMultMod$$ + "Key"], $is_range_selRangeMod$$ = !1 !== $is_range_selRangeMod$$ && $e$$72$$ && 
          $e$$72$$[$is_range_selRangeMod$$ + "Key"] && this.$_data$.ui.$last_selected$ && this.$_data$.ui.$last_selected$[0] !== $node$$48$$[0] && this.$_data$.ui.$last_selected$.parent()[0] === $node$$48$$.parent()[0], $is_selected$$ = this.isSelected($node$$48$$), $proceed$$ = !0, $t$$5$$ = this;
          if($check$$) {
            if($disSelChildren$$ && $is_multiple_selMultMod$$ && ($node$$48$$.parentsUntil(".oj-tree", "li").children("a.oj-tree-clicked").length || $node$$48$$.children("ul").find("a.oj-tree-clicked:eq(0)").length)) {
              return!1
            }
            $proceed$$ = !1;
            switch(!0) {
              case $is_range_selRangeMod$$:
                ...
                $node$$48$$ = $node$$48$$[$node$$48$$.index() < this.$_data$.ui.$last_selected$.index() ? "nextUntil" : "prevUntil"](".oj-tree-last-selected").addBack();
                -1 == this.$_data$.$core$.$selectMode$ || $node$$48$$.length < this.$_data$.$core$.$selectMode$ ? (this.$_data$.ui.$last_selected$.removeClass("oj-tree-last-selected"), this.$_data$.ui.selected.each(function() {
              ...
              case $is_selected$$ && !$is_multiple_selMultMod$$:
                ...
                break;
              case !$is_selected$$ && !$is_multiple_selMultMod$$:
                $e$$72$$ ? this.$_data$.ui.selected && 1 == this.$_data$.ui.selected.length ? this.deselect(this.$_data$.ui.selected) : this.deselectAll(this.$_data$.ui.selected) : 1 === this.$_data$.$core$.$selectMode$ ? this.deselect(this.$_data$.ui.selected) : 1 < this.$_data$.$core$.$selectMode$ && this.deselectAll();
                $proceed$$ = !0;
                break;
              case $is_selected$$ && $is_multiple_selMultMod$$:
                this.deselect($node$$48$$);
                break;
              case !$is_selected$$ && $is_multiple_selMultMod$$:
          ...
          $proceed$$ && !$is_selected$$ && ($is_range_selRangeMod$$ || (this.$_data$.ui.$last_selected$ = $node$$48$$), $node$$48$$.children("a").addClass("oj-tree-clicked"), $node$$48$$.attr("aria-selected", "true"), $rslt$$5_s$$16$$.selectedParentExpand && $node$$48$$.parents(".oj-tree-closed").each(function() {
            $t$$5$$.expand(this, !1, !0)
          }), this.$_data$.ui.selected = this.$_data$.ui.selected.add($node$$48$$), this.$_fix_scroll$($node$$48$$.eq(0)), this.$_emitEvent$({obj:$node$$48$$, e:$e$$72$$}, "select"))
        }
      }
    }, $_deselectAll$:function($context$$45$$, $bSeparate$$) {
      if(!this.$_data$.$core$.locked) {
        if($bSeparate$$) {
          if($origTarg$$2$$ = $context$$45$$ ? $context$$45$$ : -1, $ret$$36$$ = $context$$45$$ ? $$$$21$$($context$$45$$).find("a.oj-tree-clicked").parent() : this.$_$container$.find("a.oj-tree-clicked").parent(), !$ret$$36$$.hasClass("oj-disabled")) {
            var $_this$$10$$ = this;
            $$$$21$$.each($ret$$36$$, function() {
              $_this$$10$$.deselect(this)
            })
          }
        }else {
          var $origTarg$$2$$ = $context$$45$$ ? $context$$45$$ : -1, $ret$$36$$ = $context$$45$$ ? $$$$21$$($context$$45$$).find("a.oj-tree-clicked").parent() : this.$_$container$.find("a.oj-tree-clicked").parent();
          $ret$$36$$.hasClass("oj-disabled") || ($ret$$36$$.children("a.oj-tree-clicked").removeClass("oj-tree-clicked"), $ret$$36$$.removeAttr("aria-selected"), this.$_data$.ui.selected = $$$$21$$([]), this.$_data$.ui.$last_selected$ = !1, $ret$$36$$.length && this.$_emitEvent$({obj:$ret$$36$$, targ:$origTarg$$2$$}, "deselectAll"))
        }
      }
    }, $_refresh$:function($node$$49$$) {
      this.$_refresh_core$($node$$49$$)
    }, $_refresh_core$:function($node$$50$$) {
      var $origTarg$$3$$ = $node$$50$$ ? $node$$50$$ : -1, $_this$$11$$ = this;
      this.$_save_opened$();
      $node$$50$$ || ($node$$50$$ = -1);
      ($node$$50$$ = this.$_getNode$($node$$50$$)) ? $origTarg$$3$$ = $node$$50$$ : $node$$50$$ = -1;
      -1 !== $node$$50$$ ? $node$$50$$.children("UL").remove() : this.$_$container_ul$.empty();
      this.$_load_node$($node$$50$$, function() {
      ...
      var $_this$$12$$ = this;
      this.$_data$.$core$.$toExpand$.length && $$$$21$$.each(this.$_data$.$core$.$toExpand$, function($i$$230$$, $val$$42$$) {
        $_this$$12$$.$_expand$($val$$42$$, !1, !0)
      });
      ...
      var $s$$18$$ = this.options.data, $data$$114$$ = null, $ajax$$ = null;
      $s$$18$$ && ($data$$114$$ = $s$$18$$.data || null, $ajax$$ = $s$$18$$.ajax || null);
      $obj$$80$$ = this.$_getNode$($obj$$80$$);
      return-1 == $obj$$80$$ || !$obj$$80$$ || !$ajax$$ && !$$$$21$$.isFunction($data$$114$$) || $obj$$80$$.is(".oj-tree-open, .oj-tree-leaf") || 0 < $obj$$80$$.children("ul").children("li").size()
    }, reselect:function() {
      var $_this$$16$$ = this, $s$$19$$ = this.$_data$.ui.$to_select$, $s$$19$$ = $$$$21$$.map($$$$21$$.makeArray($s$$19$$), function($n$$24$$) {
        return"#" + $n$$24$$.toString().replace(/^#/, "").replace(/\\\//g, "/").replace(/\//g, "\\/").replace(/\\\./g, ".").replace(/\./g, "\\.").replace(/\:/g, "\\:")
      });
      $$$$21$$.each($s$$19$$, function($i$$231$$, $val$$44$$) {
        $val$$44$$ && "#" !== $val$$44$$ && $_this$$16$$.select($val$$44$$)
      });
    ...
    }, $_JsonDSToJson$:function($parentKey$$10$$, $node$$51$$) {
      ...
      0 < $cc$$ && ($range$$21$$.count = $cc$$, $ds$$.$fetchChildren$($parentKey$$10$$, $range$$21$$, {success:$$$$21$$.proxy(function($jns$$) {
        for(var $c$$27$$ = $jns$$.$getCount$(), $attr$$18_n$$25_r$$3$$, $i$$233$$ = 0;$i$$233$$ < $c$$27$$;$i$$233$$++) {
          $node$$51$$ = {};
          ($attr$$18_n$$25_r$$3$$ = $jns$$.getData($i$$233$$)) && ($node$$51$$.attr = $attr$$18_n$$25_r$$3$$);
          $node$$51$$.title = $jns$$.$m_nodes$[$i$$233$$].title;
          $attr$$18_n$$25_r$$3$$.$metadata$ && ($node$$51$$.metadata = $jns$$.$m_nodes$[$i$$233$$].$metadata$);
          var $key$$86$$ = $node$$51$$.attr.id;
          $attr$$18_n$$25_r$$3$$ = $ds$$.$getChildCount$($key$$86$$);
          0 < $attr$$18_n$$25_r$$3$$ && ($attr$$18_n$$25_r$$3$$ = this.$_JsonDSToJson$($key$$86$$, $node$$51$$), $node$$51$$.children = $attr$$18_n$$25_r$$3$$.$js$);
          $arJson$$.push($node$$51$$)
        }
        $rslt$$7$$.success = !0;
        $rslt$$7$$.$js$ = $arJson$$
      ...
      var $d$$7_s$$22$$ = this.$_getOptions$().data, $data$$116$$ = $d$$7_s$$22$$ && $d$$7_s$$22$$.data || null, $ajax$$1$$ = $d$$7_s$$22$$ && $d$$7_s$$22$$.ajax || null;
      !$d$$7_s$$22$$ || ($data$$116$$ || $ajax$$1$$) || ($data$$116$$ = $d$$7_s$$22$$);
      if(($obj$$83$$ = this.$_getNode$($obj$$83$$)) && -1 !== $obj$$83$$ && (this.$_data$.$ds$.$progressiveRender$ || this.$_data$.$ds$.$progressiveUnload$) && !$obj$$83$$.is(".oj-tree-open, .oj-tree-leaf") && 0 === $obj$$83$$.children("ul").children("li").length && $obj$$83$$.data("oj-tree-children")) {
        ...
        switch(!0) {
          ...
          case $$$$21$$.isFunction($data$$116$$):
            $data$$116$$.call(this, $obj$$83$$, $$$$21$$.proxy(function($d$$8$$) {
            ...
            break;
          case !!$data$$116$$ && !$ajax$$1$$ || !!$data$$116$$ && !!$ajax$$1$$ && (!$obj$$83$$ || -1 === $obj$$83$$):
            $obj$$83$$ && -1 != $obj$$83$$ || (($d$$7_s$$22$$ = this.$_parseJson$($data$$116$$, $obj$$83$$)) ? (this.$_$container_ul$.empty().append($d$$7_s$$22$$.children()), this.$_clean_node$()) : this.$_data$.$ds$.$correctState$ && this.$_$container_ul$.empty());
            $s_call$$4$$ && $s_call$$4$$.call(this);
            break;
          case !$data$$116$$ && !!$ajax$$1$$ || !!$data$$116$$ && !!$ajax$$1$$ && $obj$$83$$ && -1 !== $obj$$83$$:
            $error_func$$ = function $$error_func$$$($x$$55$$, $t$$6$$, $e$$73$$) {
              var $ef$$ = this.$_getOptions$().data.ajax.error;
              $ef$$ && $ef$$.call(this, $t$$6$$, $e$$73$$, $x$$55$$);
      ...
      var $d$$10$$ = !1, $tmp$$5$$, $i$$234$$, $j$$31$$, $title$$11$$;
      if(!$js$$1$$) {
        return $d$$10$$
      }
      ...
      if($$$$21$$.isArray($js$$1$$)) {
        ...
        $i$$234$$ = 0;
        for($j$$31$$ = $js$$1$$.length;$i$$234$$ < $j$$31$$;$i$$234$$++) {
          $tmp$$5$$ = this.$_parseJson$($js$$1$$[$i$$234$$], $obj$$84_ul2$$, !0), $tmp$$5$$.length && ($d$$10$$ = $d$$10$$.append($tmp$$5$$))
        }
        $d$$10$$ = $d$$10$$.children()
      }else {
        ...
        $$$$21$$.each($js$$1$$.data, function($i$$235$$, $m$$23$$) {
          $$$$21$$.isFunction($m$$23$$) && ($m$$23$$ = $m$$23$$.call(this, $js$$1$$));
          "string" != typeof $m$$23$$ && ("attr" == $i$$235$$ ? $tmp$$5$$.attr($m$$23$$) : "style" == $i$$235$$ && $tmp$$5$$.css($m$$23$$), "language" == $i$$235$$ && $tmp$$5$$.addClass($m$$23$$));
      ...
      var $result$$17$$ = [], $s$$23$$ = this.options, $_this$$18$$ = this, $tmp1$$, $tmp2$$, $li$$, $a$$63$$, $t$$8$$, $lang$$;
      ...
      $obj$$85$$.each(function() {
        ...
        $$$$21$$.each($li_attr$$, function($i$$236$$, $v$$2$$) {
        ...
        $a$$63$$.each(function() {
          ...
          }), $tmp2$$ = {attr:{}, title:$_this$$18$$.getText($t$$8$$, $lang$$)}, $$$$21$$.each($a_attr$$, function($k$$7$$, $z$$4$$) {
          ...
          }), $t$$8$$.children("ins").get(0).className.replace(/oj-tree[^ ]*|$/ig, "").replace(/^\s+$/ig, "").length && ($tmp2$$.$icon$ = $t$$8$$.children("ins").get(0).className.replace(/oj-tree[^ ]*|$/ig, "").replace(/\s+$/ig, " ").replace(/^ /, "").replace(/ $/, "")), $t$$8$$.children("ins").get(0).style.backgroundImage.length && ($tmp2$$.$icon$ = $t$$8$$.children("ins").get(0).style.backgroundImage.replace("url(", "").replace(")", ""))) : $tmp2$$ = $_this$$18$$.getText($t$$8$$);
          1 < $a$$63$$.length ? $tmp1$$.data.push($tmp2$$) : $tmp1$$.data = $tmp2$$
        });
        $li$$ = $li$$.find("\x3e ul \x3e li");
        $li$$.length && ($tmp1$$.children = $_this$$18$$.$_getJson$($li$$, $li_attr$$, $a_attr$$, !0));
        $result$$17$$.push($tmp1$$)
      });
      return $result$$17$$
      ...
      var $d$$11_s$$24$$ = this.$_getOptions$().data, $data$$118$$ = $d$$11_s$$24$$ && $d$$11_s$$24$$.data || null, $ajax$$2$$ = $d$$11_s$$24$$ && $d$$11_s$$24$$.ajax || null;
      ...
      switch(!0) {
        case !$data$$118$$ && !$ajax$$2$$ && $d$$11_s$$24$$ && "string" === typeof $d$$11_s$$24$$:
          this.$_loadHtmlString$($d$$11_s$$24$$, $obj$$87$$, $s_call$$5$$, $e_call$$5$$);
          break;
        case $$$$21$$.isFunction($data$$118$$):
          $data$$118$$.call(this, $obj$$87$$, $$$$21$$.proxy(function($d$$12$$) {
            this.$_loadHtmlString$($d$$12$$, $obj$$87$$, $s_call$$5$$, $e_call$$5$$)
          }, this));
          break;
        case !$data$$118$$ && !$ajax$$2$$:
          $obj$$87$$ && -1 != $obj$$87$$ || (this.$_$container_ul$.empty().append(this.$_data$.html.$originalContainerHtml$).find("li, a").filter(function() {
            return!this.firstChild || !this.firstChild.tagName || "INS" !== this.firstChild.tagName
          }).prepend("\x3cins class\x3d'oj-tree-icon'\x3e\x26#160;\x3c/ins\x3e").end().filter("a").children("ins:first-child").not(".oj-tree-icon").addClass("oj-tree-icon"), $$$$21$$.each(this.$_$container_ul$.find("li a"), function($i$$237$$, $val$$46$$) {
          ...
          }), this.$_data$.types.$defType$ && this.$_addDefType$(this.$_$container_ul$), this.$_clean_node$(), this.$_$container_ul$.find("ul").attr("role", "group"), this.$_$container_ul$.find("li").attr("role", "treeitem"), this.$_$container_ul$.find("a").attr("tabindex", -1));
          $s_call$$5$$ && $s_call$$5$$.call(this);
          break;
        case !!$data$$118$$ && !$ajax$$2$$ || !!$data$$118$$ && !!$ajax$$2$$ && (!$obj$$87$$ || -1 === $obj$$87$$):
          $obj$$87$$ && -1 != $obj$$87$$ || ($d$$11_s$$24$$ = $$$$21$$($data$$118$$), $d$$11_s$$24$$.is("ul") || ($d$$11_s$$24$$ = $$$$21$$("\x3cul /\x3e").append($d$$11_s$$24$$)), this.$_$container_ul$.empty().append($d$$11_s$$24$$.children()).find("li, a").filter(function() {
            return!this.firstChild || !this.firstChild.tagName || "INS" !== this.firstChild.tagName
          }).prepend("\x3cins class\x3d'oj-tree-icon'\x3e\x26#160;\x3c/ins\x3e").end().filter("a").children("ins:first-child").not(".oj-tree-icon").addClass("oj-tree-icon"), this.$_data$.types.$defType$ && this.$_addDefType$(this.$_$container_ul$), this.$_clean_node$(), this.$_$container_ul$.find("ul").attr("role", "group"), this.$_$container_ul$.find("li").attr("role", "treeitem"), this.$_$container_ul$.find("a").attr("tabindex", "-1"));
          $s_call$$5$$ && $s_call$$5$$.call(this);
          break;
        case !$data$$118$$ && !!$ajax$$2$$ || !!$data$$118$$ && !!$ajax$$2$$ && $obj$$87$$ && -1 !== $obj$$87$$:
          $obj$$87$$ = this.$_getNode$($obj$$87$$), $error_func$$1$$ = function $$error_func$$1$$$($x$$57$$, $t$$9$$, $e$$74$$) {
            var $ef$$1$$ = this.$_getOptions$().data.ajax.error;
            $ef$$1$$ && $ef$$1$$.call(this, $x$$57$$, $t$$9$$, $e$$74$$);
            ...
            $d$$13_parent$$26$$ ? ($d$$13_parent$$26$$ = $$$$21$$($d$$13_parent$$26$$), $d$$13_parent$$26$$.is("ul") || ($d$$13_parent$$26$$ = $$$$21$$("\x3cul /\x3e").append($d$$13_parent$$26$$)), -1 != $obj$$87$$ && $obj$$87$$ ? ($obj$$87$$.children("a.oj-tree-loading").removeClass("oj-tree-loading"), $obj$$87$$.append($d$$13_parent$$26$$).children("ul").find("li, a").filter(function() {
              return!this.firstChild || !this.firstChild.tagName || "INS" !== this.firstChild.tagName
              ...
              return!this.firstChild || !this.firstChild.tagName || "INS" !== this.firstChild.tagName
            }).prepend("\x3cins class\x3d'oj-tree-icon'\x3e\x26#160;\x3c/ins\x3e").end().filter("a").children("ins:first-child").not(".oj-tree-icon").addClass("oj-tree-icon"), $d$$13_parent$$26$$ = this.$_$container_ul$), this.$_data$.types.$defType$ && $d$$13_parent$$26$$ && this.$_addDefType$(this.$_$container_ul$), this.$_clean_node$($obj$$87$$), $s_call$$5$$ && $s_call$$5$$.call(this)) : ($obj$$87$$ && -1 !== $obj$$87$$ ? ($obj$$87$$.children("a.oj-tree-loading").removeClass("oj-tree-loading"), 
            $obj$$87$$.removeData("oj-tree-is-loading"), this.$_data$.$ds$.$correctState$ && (this.$_correct_state$($obj$$87$$), $s_call$$5$$ && $s_call$$5$$.call(this))) : this.$_data$.$ds$.$correctState$ && (this.$_$container_ul$.empty(), $s_call$$5$$ && $s_call$$5$$.call(this)), this.$_$container_ul$.find("ul").attr("role", "group"), this.$_$container_ul$.find("li").attr("role", "treeitem"))
    ...
    }, $_loadHtmlString$:function($s$$25$$, $obj$$88$$, $s_call$$6$$) {
      $s$$25$$ && "" !== $s$$25$$ && $s$$25$$.toString && "" !== $s$$25$$.toString().replace(/^[\s\n]+$/, "") ? ($s$$25$$ = $$$$21$$($s$$25$$), $s$$25$$.is("ul") || ($s$$25$$ = $$$$21$$("\x3cul /\x3e").append($s$$25$$)), -1 != $obj$$88$$ && $obj$$88$$ ? ($obj$$88$$.children("a.oj-tree-loading").removeClass("oj-tree-loading"), $obj$$88$$.append($s$$25$$).children("ul").find("li, a").filter(function() {
        return!this.firstChild || !this.firstChild.tagName || "INS" !== this.firstChild.tagName
      }).prepend("\x3cins class\x3d'oj-tree-icon'\x3e\x26#160;\x3c/ins\x3e").end().filter("a").children("ins:first-child").not(".oj-tree-icon").addClass("oj-tree-icon"), $obj$$88$$.removeData("oj-tree-is-loading"), this.$_addDefType$(this.$obj$)) : (this.$_$container_ul$.empty().append($s$$25$$.children()).find("li, a").filter(function() {
        return!this.firstChild || !this.firstChild.tagName || "INS" !== this.firstChild.tagName
      }).prepend("\x3cins class\x3d'oj-tree-icon'\x3e\x26#160;\x3c/ins\x3e").end().filter("a").children("ins:first-child").not(".oj-tree-icon").addClass("oj-tree-icon"), $$$$21$$.each(this.$_$container_ul$.find("li a"), function($i$$238$$, $val$$47$$) {
        var $ih$$1$$ = $val$$47$$.innerHTML, $ih$$1$$ = $ih$$1$$.replace("ins\x3e", "ins\x3e\x3cspan class\x3d'oj-tree-title'\x3e");
        $val$$47$$.innerHTML = $ih$$1$$ + "\x3c/span\x3e"
      }), this.$_addDefType$(this.$_$container_ul$)), this.$_clean_node$($obj$$88$$), $s_call$$6$$ && $s_call$$6$$.call(this)) : $obj$$88$$ && -1 !== $obj$$88$$ ? ($obj$$88$$.children("a.oj-tree-loading").removeClass("oj-tree-loading"), $obj$$88$$.removeData("oj-tree-is-loading"), this.$_data$.$ds$.$correctState$ && (this.$_correct_state$($obj$$88$$), $s_call$$6$$ && $s_call$$6$$.call(this))) : this.$_data$.$ds$.$correctState$ && (this.$_$container_ul$.empty(), $s_call$$6$$ && $s_call$$6$$.call(this))
    }, $_addDefType$:function($obj$$89$$) {
      var $s$$26$$, $typeAttr$$;
      this.$_data$.types.$defType$ && ($typeAttr$$ = ($s$$26$$ = this.options.types) ? $s$$26$$.attr : this.$_data$.types.$defaults$.attr, $$$$21$$.each($obj$$89$$.find("li"), function($i$$239$$, $val$$48$$) {
        $val$$48$$ = $$$$21$$($val$$48$$);
        $val$$48$$.attr($typeAttr$$) || $val$$48$$.attr($typeAttr$$, "oj-tree-deftype")
      }))
    }, $_dnd_prepare$:function() {
      var $a$$64_vars$$ = this.$_data$.dnd.$vars$;
      if($a$$64_vars$$.$r$ && $a$$64_vars$$.$r$.length) {
        this.$_data$.dnd.off = $a$$64_vars$$.$r$.offset();
        this.$_isRtl$ && (this.$_data$.dnd.off.right = this.$_data$.dnd.off.left + $a$$64_vars$$.$r$.width());
        if(this.$_data$.dnd.$foreign$) {
          return $a$$64_vars$$ = this.options.dnd.drag_check.call(this, {o:$a$$64_vars$$.$o$, r:$a$$64_vars$$.$r$}), this.$_data$.dnd.after = $a$$64_vars$$.after, this.$_data$.dnd.before = $a$$64_vars$$.before, this.$_data$.dnd.inside = $a$$64_vars$$.inside, this.$_data$.dnd.$prepared$ = !0, this.$_dnd_show$()
        }
        this.$_prepare_move$($a$$64_vars$$.$o$, $a$$64_vars$$.$r$, "before");
        this.$_data$.dnd.before = this.check_move();
        this.$_prepare_move$($a$$64_vars$$.$o$, $a$$64_vars$$.$r$, "after");
        this.$_data$.dnd.after = this.check_move();
        this.$_is_loaded$($a$$64_vars$$.$r$) ? (this.$_prepare_move$($a$$64_vars$$.$o$, $a$$64_vars$$.$r$, "inside"), this.$_data$.dnd.inside = this.check_move()) : this.$_data$.dnd.inside = !1;
      ...
      if($dnd_pos$$10$$.$prepared$) {
        ...
        $$$$21$$.each($o$$18$$, $$$$21$$.proxy(function($i$$240$$, $val$$49$$) {
          if(this.$_data$.dnd[$val$$49$$]) {
            return $ctl$$.helper.children("ins").removeClass("oj-tree-invalid").addClass("oj-tree-ok"), $r$$4$$ = $val$$49$$, !1
          }
        }, this));
      ...
      $vars$$3$$.$r$ && $vars$$3$$.$r$[0] === $e$$75$$.target.parentNode && ($dnd$$2$$.$to1$ && (clearTimeout($dnd$$2$$.$to1$), $dnd$$2$$.$to1$ = !1), $dnd$$2$$.$to2$ && (clearTimeout($dnd$$2$$.$to2$), $dnd$$2$$.$to2$ = !1))
    }, $_dnd_open$:function() {
      var $vars$$4$$ = this.$_data$.dnd.$vars$;
      this.$_data$.dnd.$to2$ = !1;
      this.expand($vars$$4$$.$r$, $$$$21$$.proxy(this.$_dnd_prepare$, this), !0)
    }, $_dnd_finish$:function($e$$76$$) {
      var $dnd$$3$$ = this.$_data$.dnd, $vars$$5$$ = this.$_data$.dnd.$vars$;
      $dnd$$3$$.$foreign$ ? ($dnd$$3$$.after || $dnd$$3$$.before || $dnd$$3$$.inside) && this.options.dnd.drag_finish.call(this, {o:$vars$$5$$.$o$, r:$vars$$5$$.$r$, p:$vars$$5$$.$last_pos$}) : (this.$_dnd_prepare$(), this.$_move_node$($vars$$5$$.$o$, $vars$$5$$.$r$, $vars$$5$$.$last_pos$, $e$$76$$[this.options.dnd.copy_modifier + "Key"]));
      $vars$$5$$.$o$ = !1;
      $vars$$5$$.$r$ = !1;
      $vars$$5$$.$m$.hide();
      $vars$$5$$.$ml$ && $vars$$5$$.$ml$.hide()
    }, $_start_drag$:function($obj$$91$$, $e$$77$$) {
      ...
      if(!$vars$$6$$.$o$.hasClass("oj-disabled") && !this.$_data$.$core$.locked) {
        ...
        this.$_drag_start$($e$$77$$, {$jstree$:!0, $obj$:$vars$$6$$.$o$}, "\x3cins class\x3d'oj-tree-icon'\x3e\x3c/ins\x3e" + $dt$$);
    ...
    }, $_drag_start$:function($e$$78$$, $data$$119$$, $html$$4$$) {
      var $ctl$$1$$ = this.$_data$.dnd.$ctl$;
      $ctl$$1$$.$is_drag$ && this.$_drag_stop$();
      try {
        $e$$78$$.currentTarget.unselectable = "on", $e$$78$$.currentTarget.onselectstart = $JSCompiler_returnArg$$(!1), $e$$78$$.currentTarget.style && ($e$$78$$.currentTarget.style.MozUserSelect = "none")
      }catch($err$$5$$) {
      }
      $ctl$$1$$.$init_x$ = $e$$78$$.pageX;
      $ctl$$1$$.$init_y$ = $e$$78$$.pageY;
      ...
      if($ctl$$2$$.$is_down$) {
        if(!$ctl$$2$$.$is_drag$) {
          if(5 < Math.abs($e$$79$$.pageX - $ctl$$2$$.$init_x$) || 5 < Math.abs($e$$79$$.pageY - $ctl$$2$$.$init_y$)) {
            $ctl$$2$$.helper.appendTo("body"), $ctl$$2$$.$is_drag$ = !0, $$$$21$$(document).triggerHandler("drag_start.ojtreeu", [{event:$e$$79$$, data:$ctl$$2$$.$user_data$}])
          }else {
            return
          }
        }
        if("mousemove" === $e$$79$$.type) {
          var $d$$14_l$$9$$ = $$$$21$$(document), $t$$11$$ = $d$$14_l$$9$$.scrollTop(), $d$$14_l$$9$$ = $d$$14_l$$9$$.scrollLeft();
          20 > $e$$79$$.pageY - $t$$11$$ ? ($vars$$7$$.$sti$ && "down" === $vars$$7$$.$dir1$ && (clearInterval($vars$$7$$.$sti$), $vars$$7$$.$sti$ = void 0), $vars$$7$$.$sti$ || ($vars$$7$$.$dir1$ = "up", $vars$$7$$.$sti$ = setInterval(function() {
          ...
          20 > $$$$21$$(window).height() - ($e$$79$$.pageY - $t$$11$$) ? ($vars$$7$$.$sti$ && "up" === $vars$$7$$.$dir1$ && (clearInterval($vars$$7$$.$sti$), $vars$$7$$.$sti$ = void 0), $vars$$7$$.$sti$ || ($vars$$7$$.$dir1$ = "down", $vars$$7$$.$sti$ = setInterval(function() {
          ...
          20 > $e$$79$$.pageX - $d$$14_l$$9$$ ? ($vars$$7$$.$sli$ && "right" === $vars$$7$$.$dir2$ && (clearInterval($vars$$7$$.$sli$), $vars$$7$$.$sli$ = void 0), $vars$$7$$.$sli$ || ($vars$$7$$.$dir2$ = "left", $vars$$7$$.$sli$ = setInterval(function() {
          ...
          20 > $$$$21$$(window).width() - ($e$$79$$.pageX - $d$$14_l$$9$$) ? ($vars$$7$$.$sli$ && "left" === $vars$$7$$.$dir2$ && (clearInterval($vars$$7$$.$sli$), $vars$$7$$.$sli$ = void 0), $vars$$7$$.$sli$ || ($vars$$7$$.$dir2$ = "right", $vars$$7$$.$sli$ = setInterval(function() {
        ...
        $ctl$$2$$.helper.css({left:$e$$79$$.pageX + $ctl$$2$$.$helper_left$ + "px", top:$e$$79$$.pageY + $ctl$$2$$.$helper_top$ + "px"});
        $$$$21$$(document).triggerHandler("drag.ojtreeu", [{event:$e$$79$$, data:$ctl$$2$$.$user_data$}])
      }
    }, $_drag_stop$:function($e$$80$$) {
      ...
      $$$$21$$(document).triggerHandler("drag_stop.ojtreeu", [{event:$e$$80$$ ? $e$$80$$ : {}, data:$ctl$$3$$.$user_data$}]);
      $ctl$$3$$.helper.remove();
      $ctl$$3$$.$init_x$ = 0;
      $ctl$$3$$.$init_y$ = 0;
      $ctl$$3$$.$user_data$ = {};
      ...
      this.$_emitEvent$($_this$$19$$.$_data$.$core$.$toExpand$, "save_opened")
    }, $_reload_nodes$:function($bExpandAll_is_callback$$1$$) {
      var $_this$$20$$ = this, $done$$ = !0, $current$$6$$ = [], $remaining$$ = [];
      $bExpandAll_is_callback$$1$$ || (this.$_data$.$core$.$reopen$ = !1, this.$_data$.$core$.$refreshing$ = !0, ($bExpandAll_is_callback$$1$$ = "all" === this.$_data$.$core$.$toExpand$) ? this.$_data$.$core$.$toExpand$ = [] : "array" === $$$$21$$.type(this.$_data$.$core$.$toExpand$) && (0 < this.$_data$.$core$.$toExpand$.length && "all" === this.$_data$.$core$.$toExpand$[0]) && (this.$_data$.$core$.$toExpand$.length = 0, $bExpandAll_is_callback$$1$$ = !0), $bExpandAll_is_callback$$1$$ && this.$_$container_ul$.find("li.oj-tree-closed").each(function() {
        $$$$21$$(this).attr("id");
        $_this$$20$$.$_data$.$core$.$toExpand$.push("#" + $$$$21$$(this).attr("id"))
      ...
      this.$_data$.$core$.$toLoad$.length && ($$$$21$$.each(this.$_data$.$core$.$toLoad$, function($i$$241$$, $val$$50$$) {
        if("#" == $val$$50$$) {
          return!0
        }
        $$$$21$$($val$$50$$).length ? $current$$6$$.push($val$$50$$) : $remaining$$.push($val$$50$$)
      }), $current$$6$$.length && (this.$_data$.$core$.$toLoad$ = $remaining$$, $$$$21$$.each($current$$6$$, function($i$$242$$, $val$$51$$) {
        $_this$$20$$.$_is_loaded$($val$$51$$) || ($_this$$20$$.$_load_node$($val$$51$$, function() {
          $_this$$20$$.$_reload_nodes$(!0)
        }, function() {
          $_this$$20$$.$_reload_nodes$(!0)
        }), $done$$ = !1)
      })));
      this.$_data$.$core$.$toExpand$.length && $$$$21$$.each(this.$_data$.$core$.$toExpand$, function($i$$243$$, $val$$52$$) {
        $_this$$20$$.expand($val$$52$$, !1, !0)
      });
      ...
      if($eventname$$ && "string" === $$$$21$$.type($eventname$$)) {
        ...
        if(!0 !== this.$_data$.$core$.locked || "unlock" === $eventname$$ || "isLocked" === $eventname$$ || "lock" === $eventname$$) {
          ...
          $item$$8$$ = $data$$120$$ ? $data$$120$$.obj : void 0;
          "loaded" === $evname_s$$inline_698$$ && ($item$$8$$ = -1);
          var $eventdata$$ = {};
          $eventdata$$.item = $item$$8$$;
          $eventdata$$.inst = $func$$11_inst$$;
          if($isBefore$$) {
            $func$$11_inst$$ = $data$$120$$.func, $eventdata$$.func = $func$$11_inst$$, $eventdata$$.args = $args$$13_rslt$$8$$, "rename" === $func$$11_inst$$ && ($eventdata$$.title = $data$$120$$.title, $eventdata$$.prevTitle = $data$$120$$.prevTitle)
          }else {
      ...
      this.$_data$.$core$.$notify_plugins$ && this.$_$container$.bind("treeload_node", $$$$21$$.proxy(function($e$$83$$, $ui$$18$$) {
      ...
      this.$_data$.$core$.$load_open$ && this.$_$container$.bind("treeload_node", $$$$21$$.proxy(function($e$$84$$, $ui$$19$$) {
      ...
      this.$_$container$.delegate(".oj-tree-list a", "click.ojtree", $$$$21$$.proxy(function($event$$262$$) {
        ...
        var $s$$28$$ = this.options.selectPrevOnDelete, $clk$$1_obj$$93$$ = this.$_getNode$($ui$$21$$.item), $clk$$1_obj$$93$$ = $clk$$1_obj$$93$$ && $clk$$1_obj$$93$$.length ? $clk$$1_obj$$93$$.find("a.oj-tree-clicked") : [], $_this$$22$$ = this;
      ...
      3 === this.$_data$.$ds$.type && (this.$_data$.$ds$.$progressiveUnload$ && this.$_$container$.bind("treeafter_close", function($e$$85$$, $ui$$23$$) {
      ...
      4 === this.$_data$.$ds$.type && (this.$_data$.html.$useExistingMarkup$ && (this.$_data$.html.$originalContainerHtml$ = this.$_$container$.find(" \x3e ul \x3e li").clone(!0), this.$_data$.html.$originalContainerHtml$.find("li").addBack().contents().filter(function() {
      ...
      $s$$30$$ && this.$_$container$.bind("treeinit", $$$$21$$.proxy(function() {
        var $types$$ = $$$$21$$.extend(!0, {}, $s$$30$$.types), $attr$$19$$ = $s$$30$$.attr || this.$_data$.types.$defaults$.attr, $icons_css$$ = "", $_this$$23$$ = this;
        $$$$21$$.each($types$$, function($i$$244$$, $tp$$) {
          $$$$21$$.each($tp$$, function($k$$9$$) {
            /^(maxDepth|maxChildren|icon|validChildren)$/.test($k$$9$$) || $_this$$23$$.$_data$.types.$attachTo$.push($k$$9$$)
          });
          ...
          if($tp$$.icon.image || $tp$$.icon.position) {
            "default" == $i$$244$$ ? ($_this$$23$$.$_data$.types.$defType$ = !0, $icons_css$$ += ".oj-tree-" + $_this$$23$$.$_index$ + " .oj-tree-list a \x3e .oj-tree-icon { ", $icons_css$$ += $_this$$23$$.$_addTypeCss$($tp$$, $icons_css$$), $icons_css$$ += "} ", $icons_css$$ += ".oj-tree-" + $_this$$23$$.$_index$ + " .oj-tree-list li[" + $attr$$19$$ + '\x3d"oj-tree-deftype"] \x3e a .oj-tree-icon { ') : $tp$$.icon.image && ($icons_css$$ += ".oj-tree-" + $_this$$23$$.$_index$ + " .oj-tree-list li[" + 
            $attr$$19$$ + '\x3d"' + $i$$244$$ + '"] \x3e a \x3e ins.oj-tree-icon { '), $icons_css$$ += $_this$$23$$.$_addTypeCss$($tp$$, $icons_css$$), $icons_css$$ += "} "
          }
        });
        "" !== $icons_css$$ && $_addSheet$$({$str$:$icons_css$$, title:"oj-tree-types"})
      }, this)).bind("ojbefore", $$$$21$$.proxy(function($e$$86$$, $data$$122$$) {
        var $d$$15_o$$21_s$$31$$, $ty$$1$$, $func$$12$$ = $data$$122$$.func, $item$$9$$ = $data$$122$$.item;
        if(($d$$15_o$$21_s$$31$$ = ($d$$15_o$$21_s$$31$$ = this.$_data$.types.$defaults$.useData ? this.$_getNode$($item$$9$$) : !1) && -1 !== $d$$15_o$$21_s$$31$$ && $d$$15_o$$21_s$$31$$.length ? $d$$15_o$$21_s$$31$$.data("oj-tree") : !1) && $d$$15_o$$21_s$$31$$.types && !1 === $d$$15_o$$21_s$$31$$[$func$$12$$] || -1 !== $$$$21$$.inArray($func$$12$$, this.$_data$.types.$attachTo$) && ($data$$122$$.item && ($data$$122$$.item.tagName || $data$$122$$.item.jquery)) && ($d$$15_o$$21_s$$31$$ = this.options.types.types, 
        $ty$$1$$ = this.$_getType$($item$$9$$), ($d$$15_o$$21_s$$31$$[$ty$$1$$] && "undefined" !== typeof $d$$15_o$$21_s$$31$$[$ty$$1$$][$func$$12$$] || $d$$15_o$$21_s$$31$$["default"] && "undefined" !== typeof $d$$15_o$$21_s$$31$$["default"][$func$$12$$]) && !1 === this.$_check$($func$$12$$, $item$$9$$))) {
          return $e$$86$$.stopImmediatePropagation(), !1
        }
      }, this))
      ...
      if(this.$_data$.dnd.$reorder$) {
        ...
        $s$$32_vars$$9$$.$m$ = $$$$21$$("\x3cdiv /\x3e").addClass("oj-tree-marker").hide().html("\x26raquo;").bind("mouseleave mouseenter", $$$$21$$.proxy(function($e$$87$$) {
          var $vars$$10$$ = this.$_data$.dnd.$vars$;
          $vars$$10$$.$m$.hide();
          $vars$$10$$.$ml$.hide();
          $e$$87$$.preventDefault();
          $e$$87$$.stopImmediatePropagation();
          return!1
        }, this)).appendTo("body");
        $s$$32_vars$$9$$.$ml$ = $$$$21$$("\x3cdiv /\x3e").addClass("oj-tree-marker-line").hide().bind("mouseup", function($e$$88$$) {
          var $vars$$11$$ = this.$_data$.dnd.$vars$;
          if($vars$$11$$.$r$ && $vars$$11$$.$r$.length) {
            return $vars$$11$$.$r$.children("a").trigger($e$$88$$), $e$$88$$.preventDefault(), $e$$88$$.stopImmediatePropagation(), !1
          }
        }).bind("mouseleave", $$$$21$$.proxy(function($e$$89$$) {
          var $vars$$12$$ = this.$_data$.dnd.$vars$, $rt$$ = $$$$21$$($e$$89$$.relatedTarget);
          if(($rt$$.is(".oj-tree") || 0 === $rt$$.closest(".oj-tree").length) && $vars$$12$$.$r$ && $vars$$12$$.$r$.length) {
            return $vars$$12$$.$r$.children("a").trigger($e$$89$$), $vars$$12$$.$m$.hide(), $vars$$12$$.$ml$.hide(), $e$$89$$.preventDefault(), $e$$89$$.stopImmediatePropagation(), !1
          }
        }, this)).appendTo("body");
        $$$$21$$(document).bind("drag_start.ojtreeu", $$$$21$$.proxy(function($e$$90$$, $data$$123$$) {
          var $vars$$13$$ = this.$_data$.dnd.$vars$;
          $data$$123$$.data.$jstree$ && ($vars$$13$$.$m$.show(), $vars$$13$$.$ml$ && $vars$$13$$.$ml$.show())
        }, this));
        $$$$21$$(document).bind("drag_stop.ojtreeu", $$$$21$$.proxy(function($e$$91$$, $data$$124$$) {
          var $vars$$14$$ = this.$_data$.dnd.$vars$;
          $data$$124$$.data.$jstree$ && ($vars$$14$$.$m$.hide(), $vars$$14$$.$ml$ && $vars$$14$$.$ml$.hide())
        }, this));
        this.$_$container$.bind("mouseenter.ojtree", $$$$21$$.proxy(function($e$$92_tr$$) {
          var $ctl$$4$$ = this.$_data$.dnd.$ctl$, $dc_vars$$15$$ = this.$_data$.dnd.$vars$;
          $ctl$$4$$.$is_drag$ && $ctl$$4$$.$user_data$.$jstree$ && (this.options.themes && ($dc_vars$$15$$.$m$.addClass("oj-tree-" + this.$_data$.$themes$.$theme$), $dc_vars$$15$$.$ml$ && $dc_vars$$15$$.$ml$.addClass("oj-tree-" + this.$_data$.$themes$.$theme$), $ctl$$4$$.helper.addClass("oj-tree-dnd-helper oj-tree-" + this.$_data$.$themes$.$theme$)), $e$$92_tr$$.currentTarget === $e$$92_tr$$.target && ($ctl$$4$$.$user_data$.$obj$ && $$$$21$$($ctl$$4$$.$user_data$.$obj$).length && $$$$21$$($ctl$$4$$.$user_data$.$obj$).parents(".oj-tree:eq(0)")[0] !== 
          $e$$92_tr$$.target) && ($e$$92_tr$$ = this.$_reference$($e$$92_tr$$.target), $e$$92_tr$$.data.dnd.$foreign$ ? ($dc_vars$$15$$ = $e$$92_tr$$.options.dnd.drag_check.call(this, {o:$dc_vars$$15$$.$o$, r:$e$$92_tr$$.$_$container$, is_root:!0}), !0 !== $dc_vars$$15$$ && !0 !== $dc_vars$$15$$.inside && !0 !== $dc_vars$$15$$.before && !0 !== $dc_vars$$15$$.after || $ctl$$4$$.helper.children("ins").removeClass("oj-tree-invalid").addClass("oj-tree-ok")) : ($e$$92_tr$$.$_prepare_move$($dc_vars$$15$$.$o$, 
          $e$$92_tr$$.$_$container$, "last"), $e$$92_tr$$.check_move() && $ctl$$4$$.helper.children("ins").removeClass("oj-tree-invalid").addClass("oj-tree-ok"))))
        }, this)).bind("mouseup.ojtree", $$$$21$$.proxy(function($dc$$1_e$$93$$) {
          var $vars$$16$$ = this.$_data$.dnd.$vars$, $ctl$$5_tr$$1$$ = this.$_data$.dnd.$ctl$;
          $ctl$$5_tr$$1$$.$is_drag$ && ($ctl$$5_tr$$1$$.$user_data$.$jstree$ && $dc$$1_e$$93$$.currentTarget === $dc$$1_e$$93$$.target && $ctl$$5_tr$$1$$.$user_data$.$obj$ && $$$$21$$($ctl$$5_tr$$1$$.$user_data$.$obj$).length && $$$$21$$($ctl$$5_tr$$1$$.$user_data$.$obj$).parents(".oj-tree:eq(0)")[0] !== $dc$$1_e$$93$$.target) && ($ctl$$5_tr$$1$$ = this.$_reference$($dc$$1_e$$93$$.currentTarget), $ctl$$5_tr$$1$$.data.dnd.foreign ? ($dc$$1_e$$93$$ = $ctl$$5_tr$$1$$.$_getOptions$().dnd.drag_check.call(this, 
          {o:$vars$$16$$.$o$, r:$ctl$$5_tr$$1$$.$_$container$, is_root:!0}), !0 !== $dc$$1_e$$93$$ && !0 !== $dc$$1_e$$93$$.inside && !0 !== $dc$$1_e$$93$$.before && !0 !== $dc$$1_e$$93$$.after || $ctl$$5_tr$$1$$.$_getOptions$().dnd.drag_finish.call(this, {o:$vars$$16$$.$o$, r:$ctl$$5_tr$$1$$.$_$container$, is_root:!0})) : $ctl$$5_tr$$1$$.$_move_node$($vars$$16$$.$o$, $ctl$$5_tr$$1$$.$_$container$, "last", $dc$$1_e$$93$$[$ctl$$5_tr$$1$$.options.dnd.copy_modifier + "Key"]))
        }, this)).bind("mouseleave.ojtree", $$$$21$$.proxy(function($e$$94$$) {
          var $ctl$$6$$ = this.$_data$.dnd.$ctl$;
          if($e$$94$$.relatedTarget && $$$$21$$($e$$94$$.relatedTarget).hasClass("oj-tree-marker-line")) {
            return!1
          }
        ...
        }, this)).bind("mousemove.ojtree", $$$$21$$.proxy(function($e$$95$$) {
          var $ctl$$7$$ = this.$_data$.dnd.$ctl$;
          if($ctl$$7$$.$is_drag$ && $ctl$$7$$.$user_data$.$jstree$) {
            var $cnt$$1$$ = this.$_$container$[0];
            $e$$95$$.pageX + 24 > this.$_data$.dnd.$cof$.left + this.$_data$.dnd.$cw$ ? (this.$_data$.dnd.$i1$ && clearInterval(this.$_data$.dnd.$i1$), this.$_data$.dnd.$i1$ = setInterval($$$$21$$.proxy(function() {
              this.scrollLeft += $ctl$$7$$.$scroll_spd$
            }, $cnt$$1$$), 100)) : $e$$95$$.pageX - 24 < this.$_data$.dnd.$cof$.left ? (this.$_data$.dnd.$i1$ && clearInterval(this.$_data$.dnd.$i1$), this.$_data$.dnd.$i1$ = setInterval($$$$21$$.proxy(function() {
              this.scrollLeft -= $ctl$$7$$.$scroll_spd$
            }, $cnt$$1$$), 100)) : this.$_data$.dnd.$i1$ && clearInterval(this.$_data$.dnd.$i1$);
            $e$$95$$.pageY + 24 > this.$_data$.dnd.$cof$.top + this.$_data$.dnd.ch ? (this.$_data$.dnd.$i2$ && clearInterval(this.$_data$.dnd.$i2$), this.$_data$.dnd.$i2$ = setInterval($$$$21$$.proxy(function() {
              this.scrollTop += $ctl$$7$$.$scroll_spd$
            }, $cnt$$1$$), 100)) : $e$$95$$.pageY - 24 < this.$_data$.dnd.$cof$.top ? (this.$_data$.dnd.$i2$ && clearInterval(this.$_data$.dnd.$i2$), this.$_data$.dnd.$i2$ = setInterval($$$$21$$.proxy(function() {
              this.scrollTop -= $ctl$$7$$.$scroll_spd$
        ...
        }, this)).delegate(".oj-tree-list a", "mousedown.ojtree", $$$$21$$.proxy(function($e$$97$$) {
          if(1 === $e$$97$$.which) {
            return this.$_start_drag$($e$$97$$.currentTarget, $e$$97$$), !1
          }
        }, this)).delegate(".oj-tree-list a", "mouseenter.ojtree", $$$$21$$.proxy(function($e$$98$$) {
          var $ctl$$9$$ = this.$_data$.dnd.$ctl$;
          $ctl$$9$$.$is_drag$ && $ctl$$9$$.$user_data$.$jstree$ && this.$_dnd_enter$($e$$98$$.currentTarget)
        }, this)).delegate(".oj-tree-list a", "mousemove.ojtree", $$$$21$$.proxy(function($e$$99$$) {
          var $ctl$$10$$ = this.$_data$.dnd.$ctl$, $vars$$18$$ = this.$_data$.dnd.$vars$;
          $ctl$$10$$.$is_drag$ && $ctl$$10$$.$user_data$.$jstree$ && ($vars$$18$$.$r$ && $vars$$18$$.$r$.length && $vars$$18$$.$r$.children("a")[0] === $e$$99$$.currentTarget || this.$_dnd_enter$($e$$99$$.currentTarget), "undefined" === typeof this.$_data$.dnd.off.top && (this.$_data$.dnd.off = $$$$21$$($e$$99$$.target).offset()), "undefined" === typeof this.$_data$.dnd.off.top && (this.$_data$.dnd.off = $$$$21$$($e$$99$$.target).offset()), this.$_data$.dnd.$w$ = ($e$$99$$.pageY - (this.$_data$.dnd.off.top || 
          0)) % this.$_data$.$core$.$li_height$, 0 > this.$_data$.dnd.$w$ && (this.$_data$.dnd.$w$ += this.$_data$.$core$.$li_height$), this.$_dnd_show$())
        }, this)).delegate(".oj-tree-list a", "mouseleave.ojtree", $$$$21$$.proxy(function($e$$100$$) {
          var $ctl$$11$$ = this.$_data$.dnd.$ctl$, $vars$$19$$ = this.$_data$.dnd.$vars$;
          if($ctl$$11$$.$is_drag$ && $ctl$$11$$.$user_data$.$jstree$) {
            if($e$$100$$.relatedTarget && $$$$21$$($e$$100$$.relatedTarget).hasClass("oj-tree-marker-line")) {
              return!1
            }
            ...
            this.$_data$.dnd.$mto$ = setTimeout(function($t$$14$$) {
              return function() {
                $t$$14$$.$_dnd_leave$($e$$100$$)
              }
            }(this), 0)
          }
        }, this)).delegate(".oj-tree-list a", "mouseup.ojtree", $$$$21$$.proxy(function($e$$101$$) {
          var $ctl$$12$$ = this.$_data$.dnd.$ctl$;
          $ctl$$12$$.$is_drag$ && $ctl$$12$$.$user_data$.$jstree$ && this.$_dnd_finish$($e$$101$$)
        }, this));
        ...
        }, this)).bind("drag_start.ojtreeu", $$$$21$$.proxy(function($e$$102$$, $data$$125$$) {
          if($data$$125$$.data.$jstree$) {
            var $et$$ = $$$$21$$($data$$125$$.event.target);
            $et$$.closest(".jstree").hasClass("oj-tree-" + this.$_index$) && this.$_dnd_enter$($et$$)
          }
        }, this));
        $s$$32_vars$$9$$ = this.options.dnd;
        $s$$32_vars$$9$$.drag_target && $$$$21$$(document).delegate($s$$32_vars$$9$$.drag_target, "mousedown.ojtree-" + this.$_index$, $$$$21$$.proxy(function($e$$103$$) {
          var $cnt$$2_ctl$$13$$ = this.$_data$.dnd.$ctl$, $dnd$$6$$ = this.$_data$.dnd, $vars$$21$$ = this.$_data$.dnd.$vars$;
          $vars$$21$$.$o$ = $e$$103$$.target;
          this.$_drag_start$($e$$103$$, {$jstree$:!0, $obj$:$e$$103$$.target}, "\x3cins class\x3d'oj-tree-icon'\x3e\x3c/ins\x3e" + $$$$21$$($e$$103$$.target).text());
        ...
        $s$$32_vars$$9$$.drop_target && $$$$21$$(document).delegate($s$$32_vars$$9$$.drop_target, "mouseenter.ojtreex-" + this.$_index$, $$$$21$$.proxy(function($e$$104$$) {
          var $dnd$$7$$ = this.$_data$.dnd, $vars$$22$$ = this.$_data$.dnd.$vars$;
          $dnd$$7$$.$active$ && this.options.dnd.drop_check.call(this, {o:$vars$$22$$.$o$, r:$$$$21$$($e$$104$$.target), e:$e$$104$$}) && $dnd$$7$$.$ctl$.helper.children("ins").removeClass("oj-tree-invalid").addClass("oj-tree-ok")
        ...
        }, this)).delegate($s$$32_vars$$9$$.drop_target, "mouseup.ojtreex-" + this.$_index$, $$$$21$$.proxy(function($e$$106$$) {
          var $vars$$23$$ = this.$_data$.dnd.$vars$;
          this.$_data$.dnd.$active$ && this.$_data$.dnd.$ctl$.helper.children("ins").hasClass("oj-tree-ok") && this.options.dnd.drop_finish.call(this, {o:$vars$$23$$.$o$, r:$$$$21$$($e$$106$$.target), e:$e$$106$$})
        }, this))
      }
    ...
    }, $_handleContextMenuBeforeShow$:function($e$$109_state$$3$$) {
      this.$_data$.menu.$node$ = "keydown" === $e$$109_state$$3$$.originalEvent.originalEvent.type ? this.$_data$.ui.$hovered$ : $$$$21$$($e$$109_state$$3$$.originalEvent.target.parentNode);
      ...
      if(this.$_data$.menu.$usermenu$ && this.$_data$.menu.$$elemPaste$) {
        $e$$109_state$$3$$ = this.$_data$.menu.$$elemPaste$.hasClass("oj-disabled");
        var $disabledState$$ = !this.$_data$.$crrm$.$ct_nodes$ && !this.$_data$.$crrm$.$cp_nodes$;
        $e$$109_state$$3$$ || ($e$$109_state$$3$$ = !1);
        $e$$109_state$$3$$ != $disabledState$$ && ($disabledState$$ ? this.$_data$.menu.$$elemPaste$.addClass("oj-disabled") : this.$_data$.menu.$$elemPaste$.removeClass("oj-disabled"), this.$_data$.menu.$$container$.ojMenu("refresh"))
      }
      ...
      var $val$$53$$ = this.options.selectionMode, $val$$53$$ = void 0 == $val$$53$$ ? "single" : $val$$53$$;
      "none" === $val$$53$$ ? $val$$53$$ = 0 : "single" === $val$$53$$ ? $val$$53$$ = 1 : "multiple" === $val$$53$$ && ($val$$53$$ = -1);
      this.$_data$.$core$.$selectMode$ = $val$$53$$;
      ...
      $data$$127$$.ui = {selected:$$$$21$$(), $last_selected$:!1, $hovered$:null, $to_select$:null, opacity:1, $spacebar$:!1, $focused$:!1};
      $data$$127$$.ui.$defaults$ = {selectMultipleModifier:"ctrl", selectRangeModifier:"shift", disableSelectingChildren:!1};
      $data$$127$$.$crrm$ = {};
      ...
      $data$$127$$.dnd.$i2$ = !1;
      $data$$127$$.dnd.$mto$ = !1;
      $data$$127$$.dnd.$defaults$ = {copy_modifier:"ctrl", check_timeout:100, open_timeout:500, drop_target:".oj-tree-drop", drop_check:$JSCompiler_returnArg$$(!0), drop_finish:$$$$21$$.noop, drag_target:".oj-tree-draggable", drag_finish:$$$$21$$.noop, drag_check:function $$data$$127$$$dnd$$defaults$$drag_check$() {
      ...
      var $ret$$37$$ = null;
      $$$$21$$.each($_aInstances$$, function($i$$245$$, $_this$$24$$) {
        if($_this$$24$$.$_data$.ui.$focused$) {
          return $ret$$37$$ = $_this$$24$$, !1
        }
      });
      return $ret$$37$$
    }, $_newIndex$:function() {
      ...
      var $a$$65$$ = this.$_$container_ul$.find("li.oj-tree-last:visible");
      this.hover($a$$65$$[$a$$65$$.length - 1]);
      return!1
    }, "*":function() {
      ...
      if($hover$$1$$) {
        var $bContinue$$ = !0, $_this$$25$$ = this, $nodes$$2$$ = this.$_$container_ul$.find("li:visible"), $hover$$1$$ = $hover$$1$$[0];
        $$$$21$$.each($nodes$$2$$, function($i$$246$$, $node$$52$$) {
          $node$$52$$ == $hover$$1$$ && ($bContinue$$ = !1);
          $_this$$25$$.$_select$($node$$52$$, !0);
          return $bContinue$$
        })
      }
      return!1
      ...
      if($hover$$2$$) {
        var $bFound$$ = !1, $_this$$26$$ = this, $l$$11$$ = this.$_$container_ul$.find("li:visible"), $hover$$2$$ = $hover$$2$$[0];
        $$$$21$$.each($l$$11$$, function($i$$247$$, $node$$53$$) {
          $bFound$$ || $node$$53$$ == $hover$$2$$ && ($bFound$$ = !0);
          $bFound$$ && $_this$$26$$.$_select$($node$$53$$, !0);
          return!0
        })
      }
      return!1
      ...
      if(this.$_data$.menu.$usermenu$) {
        ...
        $$menuContainer$$.find("[data-oj-command]").each(function() {
          var $cmd$$;
          0 === $$$$21$$(this).children("a").length && ($cmd$$ = $$$$21$$(this).attr("data-oj-command").split("-"), $$$$21$$(this).replaceWith($_this$$27$$.$_buildContextMenuItem$($cmd$$[$cmd$$.length - 1])), $$$$21$$(this).hasClass("oj-menu-divider") && ($$$$21$$(this).removeClass("oj-menu-divider"), $$$$21$$(this).addClass("oj-menu-item")), $bChanged$$ = !0)
        });
      ...
      "relative").append($$$$21$$("\x3cinput /\x3e", {value:$t$$19$$, "class":"oj-tree-rename-input", css:{padding:"0", border:"1px solid silver", position:"absolute", left:$rtl$$2$$ ? "auto" : $w1$$ + $w2$$ + 4 + "px", right:$rtl$$2$$ ? $w1$$ + $w2$$ + 4 + "px" : "auto", top:"0px", height:this.$_data$.$core$.$li_height$ - 2 + "px", lineHeight:this.$_data$.$core$.$li_height$ - 2 + "px", width:"150px"}, blur:$$$$21$$.proxy(function() {
        ...
        27 == $event$$273_key$$87$$ ? ($_this$$28$$.$_done$ = !1, this.value = $t$$19$$, this.blur()) : 13 == $event$$273_key$$87$$ ? ($_this$$28$$.$_done$ = !1, this.blur()) : $h2$$.width(Math.min($h1$$.text("pW" + this.value).width(), $w$$7$$))
      ...
      return this.$_create_node$($obj$$103$$, $position$$14$$, $js$$2$$, function($t$$21$$) {
        ...
        $skip_rename$$ ? $_this$$29$$.$_emitEvent$({obj:$t$$21$$, name:this.getText($t$$21$$), parent:$p$$12$$, position:$pos$$11$$}) : this.$_crrm_showInput$($t$$21$$, function($obj$$104$$, $new_name$$1$$) {
          $_this$$29$$.$_emitEvent$({obj:$obj$$104$$, name:$new_name$$1$$, parent:$p$$12$$, position:$pos$$11$$})
        })
      })
    ...
    }, $_processSubId$:function($l$$12_locator$$15$$) {
      var $subId$$9$$ = $l$$12_locator$$15$$.subId, $origNode$$ = $l$$12_locator$$15$$.node, $node$$54$$ = $origNode$$ ? this.$_getNode$($origNode$$) : null, $key$$89$$ = "string" === typeof $l$$12_locator$$15$$.key ? $l$$12_locator$$15$$.key : null, $val$$54$$ = "string" === typeof $l$$12_locator$$15$$.value ? $l$$12_locator$$15$$.value : null, $$elem$$, $txt$$1$$;
      switch($subId$$9$$) {
        case "disclosure":
          if(-1 === $origNode$$ || -1 === $node$$54$$) {
            return this.$_$container_ul$ ? this.$_$container_ul$[0] : null
          }
          if($key$$89$$) {
            $l$$12_locator$$15$$ = this.$_$container_ul$.find("li"), $$$$21$$.each($l$$12_locator$$15$$, function($i$$249$$, $v$$5$$) {
              $v$$5$$ = $$$$21$$($v$$5$$);
              if($v$$5$$.attr($key$$89$$) && $v$$5$$.attr($key$$89$$) === $val$$54$$) {
                return $node$$54$$ = $v$$5$$, !1
              }
            })
          }else {
            if(!$node$$54$$ && "string" === typeof $origNode$$) {
              $txt$$1$$ = $origNode$$.trim();
              $l$$12_locator$$15$$ = this.$_$container_ul$.find("a");
              $$$$21$$.each($l$$12_locator$$15$$, function($i$$250$$, $v$$6$$) {
              ...
              $node$$54$$ = $$elem$$.closest("li")
            }else {
              if($node$$54$$ && this.$_isLeaf$($node$$54$$)) {
                break
              }
            }
          }
          if($node$$54$$ && !this.$_isLeaf$($node$$54$$)) {
            return $node$$54$$.find(" \x3e ins:eq(0)")
          }
          break;
        case "icon":
          if(-1 === $origNode$$ || -1 === $node$$54$$) {
          ...
          if($key$$89$$) {
            return $l$$12_locator$$15$$ = this.$_$container_ul$.find("li"), $$$$21$$.each($l$$12_locator$$15$$, function($i$$251$$, $v$$7$$) {
              $v$$7$$ = $$$$21$$($v$$7$$);
              if($v$$7$$.attr($key$$89$$) && $v$$7$$.attr($key$$89$$) === $val$$54$$) {
                return $node$$54$$ = $v$$7$$, !1
              }
            }), $node$$54$$ && ($node$$54$$ = $node$$54$$.find(" \x3e a").closest("ins")), $node$$54$$
          }
          if(!$node$$54$$ && "string" === typeof $origNode$$) {
            return $txt$$1$$ = $origNode$$.trim(), $l$$12_locator$$15$$ = this.$_$container_ul$.find("a"), $$$$21$$.each($l$$12_locator$$15$$, function($i$$252$$, $v$$8$$) {
              if($v$$8$$.text.trim() === $txt$$1$$) {
                return $$elem$$ = $$$$21$$($v$$8$$), !1
              }
            }), $$elem$$
          }
          if($node$$54$$ && $node$$54$$.length) {
            return $node$$54$$.find(" \x3e a \x3e ins:eq(0)")
          }
          break;
        case "link":
          if(-1 === $origNode$$ || -1 === $node$$54$$) {
          ...
          if($key$$89$$) {
            return $l$$12_locator$$15$$ = this.$_$container_ul$.find("li"), $$$$21$$.each($l$$12_locator$$15$$, function($i$$253$$, $v$$9$$) {
              $v$$9$$ = $$$$21$$($v$$9$$);
              if($v$$9$$.attr($key$$89$$) && $v$$9$$.attr($key$$89$$) === $val$$54$$) {
                return $node$$54$$ = $v$$9$$, !1
              }
            }), $node$$54$$ && ($node$$54$$ = $node$$54$$.find(" \x3e a:eq(0)")) ? $node$$54$$ : !1
          }
          if(!$node$$54$$ && "string" === typeof $origNode$$) {
            return $txt$$1$$ = $origNode$$.trim(), $l$$12_locator$$15$$ = this.$_$container_ul$.find("a"), $$$$21$$.each($l$$12_locator$$15$$, function($i$$254$$, $v$$10$$) {
          ...
          if($node$$54$$ && $node$$54$$.length) {
            return $node$$54$$.find(" a:eq(0)")
          }
          break;
        case "parent":
          return $node$$54$$ && -1 !== $origNode$$ && ($node$$54$$ = this.$_getParent$($node$$54$$)), $node$$54$$ = $node$$54$$ && -1 != $node$$54$$ ? $node$$54$$ : null;
        case "first":
          return $node$$54$$ && -1 != $node$$54$$ && -1 != $origNode$$ || ($node$$54$$ = this.$_$container_ul$), $node$$54$$.find("li:eq(0)");
        case "last":
          return $node$$54$$ && -1 != $node$$54$$ && -1 != $origNode$$ || ($node$$54$$ = this.$_$container_ul$), $node$$54$$.find("li:last-child").last();
        case "prevSib":
          return $node$$54$$ = -1 !== $node$$54$$ ? ($node$$54$$ = this.$_getPrev$($node$$54$$, !0)) ? $node$$54$$[0] : null : null, $node$$54$$;
        case "nextSib":
          return $node$$54$$ = -1 !== $node$$54$$ ? ($node$$54$$ = this.$_getNext$($node$$54$$, !0)) ? $node$$54$$[0] : null : null, $node$$54$$
      }
      return null
    }})
  })()
