define({
        ...
        'range':
        {
          ...
          'datetime': 
          {
            ...
            'min':
            {
              ...
              'detail' : 'Il valore di data/ora {value} deve essere uguale o successivo a {min}.',
              'hint' : 'Immettere un valore di data/ora uguale o successivo a {min}.'
            },
            'max':
            {
              'summary' : 'Valore di data/ora successivo alla data massima.',
              'detail' : 'Il valore di data/ora {value} deve essere uguale o precedente a {max}.',
	...
	'inputDetail': 'Premere il tasto freccia GIÙ o il tasto freccia SU per accedere al calendario',
        'inputDetailBoth': 'Premere il tasto freccia GIÙ o il tasto freccia SU per accedere al calendario e Alt + tasto freccia GIÙ o tasto freccia SU per accedere all\'elenco a discesa dell\'ora'
      },

      'oj-ojInputTime':
      {
        'inputDetail': 'Premere il tasto freccia GIÙ o il tasto freccia SU per accedere all\'elenco a discesa dell\'ora'
      },
      ...
      'oj-ojTable': 
      {
        ...
        {
          'summary': 'La riga attiva non è stata modificata a causa dell\'indice di riga non disponibile.',
          'detail': 'Indice di riga non disponibile: {rowIdx}.'
        },
        'columnRendererColumnNotFound':
        {
          'summary': 'Impossibile trovare la colonna con ID {columnId} per il renderer della colonna.',
          'detail': 'Assicurarsi che una colonna con ID colonna corrispondente esista per il renderer della colonna.'
        },
        'columnRendererOptionRequired':
        {
          'summary': 'Per il renderer della colonna è richiesta l\'opzione {option}.',
          'detail': 'Specificare l\'opzione {option} per il renderer della colonna.'
        },
        'dataInvalidType':
        {
          'summary': 'Tipo di dati non valido.',
          'detail': 'Specificare il tipo di dati appropriato.'
        },
        'dataUnitialized':
        {
          'summary': 'Dati vuoti o non inizializzati.',
          'detail': 'Specificare i dati.'
        },
        'preActiveRowError':
        {
          'summary': 'La riga attiva non è stata modificata a causa di un errore.',
          'detail': 'Dettagli errore: {error}.'
        },
        'refreshRowInvalidRowIndex':
        {
          'summary': 'Valore indice di riga non valido.',
          'detail': 'Indice di riga: {rowIdx}.'
        },
        'tableDataSourceInstantiated':
        {
          'summary': 'Chiamato costruttore oj.TableDataSource.',
          'detail': 'Non creare un\'istanza di oj.TableDataSource. Utilizzare invece una delle classi secondarie come oj.ArrayTableDataSource oppure oj.CollectionTableDataSource.'
        }
      },
