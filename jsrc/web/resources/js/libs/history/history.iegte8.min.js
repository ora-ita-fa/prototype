...
else try{u(a,b,{value:D})}catch(q){}a[b]=l}else if(!f||!g)try{try{var m=E.create(a);u(E.getPrototypeOf(m)===a?m:a,b,c);for(var o in a)"function"===typeof a[o]&&(m[o]=a[o].bind(a));try{d.call(m,m,a)}catch(r){}a=m}catch(s){u(a.constructor.prototype,b,c)}}catch(t){return n}return a}function X(a,b,c){c=c||{};a=a===J?f:a;c.set=c.set||function(c){a[b]=c};c.get=c.get||function(){return a[b]};return c}function Y(a,b,c){a in s?s[a].push(b):3<arguments.length?o(a,b,c,arguments[3]):o(a,b,c)}function Z(a,b,c){var d=
s[a];if(d)for(a=d.length;--a;){if(d[a]===b){d.splice(a,1);break}}else K(a,b,c)}function A(a,b){var c=(""+("string"===typeof a?a:a.type)).replace(/^on/,""),d=s[c];if(d){b="string"===typeof a?b:a;if(b.target==j)for(var f=["target","currentTarget","srcElement","type"];a=f.pop();)b=z(b,a,{get:"type"===a?function(){return c}:function(){return e}});(("popstate"===c?e.onpopstate:e.onhashchange)||D).call(e,b);for(var f=0,g=d.length;f<g;f++)d[f].call(e,b);return i}return $(a,b)}function L(){var a=g.createEvent?
g.createEvent("Event"):g.createEventObject();a.initEvent?a.initEvent("popstate",n,n):a.type="popstate";a.state=h.state;A(a)}function v(a,b,c,d){p||(b=k(b),b.c!==k().c&&(w=d,c?f.replace("#"+b.f):f.hash=b.f));!B&&a&&(m[f.href]=a);C=n}function M(a){var b=w;w=f.href;if(b){N!==f.href&&L();var a=a||e.event,b=k(w,i),c=k();a.oldURL||(a.oldURL=b.b,a.newURL=c.b);b.a!==c.a&&A(a)}}function O(a){setTimeout(function(){o("popstate",function(a){N=f.href;B||(a=z(a,"state",{get:function(){return h.state}}));A(a)},
n)},0);!p&&(a!==i&&h.location)&&(P(h.location.hash),C&&(C=n,L()))}function aa(a){var a=a||e.event,b;a:{for(b=a.target||a.srcElement;b;){if("A"===b.nodeName)break a;b=b.parentNode}b=void 0}var c="defaultPrevented"in a?a.defaultPrevented:a.returnValue===n;b&&("A"===b.nodeName&&!c)&&(c=k(),b=k(b.getAttribute("href",2)),c.b.split("#").shift()===b.b.split("#").shift()&&b.a&&(c.a!==b.a&&(h.location.hash=b.a),P(b.a),a.preventDefault?a.preventDefault():a.returnValue=n))}function P(a){var b=g.getElementById(a=
